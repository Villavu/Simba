...
procedure TControl_AdjustSize(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.AdjustSize();
end;

//function AutoSizeDelayed: boolean;
procedure TControl_AutoSizeDelayed(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.AutoSizeDelayed();
end;

//function AutoSizeDelayedReport: string;
procedure TControl_AutoSizeDelayedReport(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PControl(Params^[0])^.AutoSizeDelayedReport();
end;

//function AutoSizeDelayedHandle: Boolean;
procedure TControl_AutoSizeDelayedHandle(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.AutoSizeDelayedHandle();
end;

//procedure SetBounds(aLeft, aTop, aWidth, aHeight: integer);
procedure TControl_SetBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_SetInitialBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_SetBoundsKeepBase(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_GetPreferredSize(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_GetDefaultWidth(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PControl(Params^[0])^.GetDefaultWidth();
end;

//function GetDefaultHeight: integer;
procedure TControl_GetDefaultHeight(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PControl(Params^[0])^.GetDefaultHeight();
end;

//function GetColorResolvingParent: Integer;
procedure TControl_GetColorResolvingParent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetColorResolvingParent();
end;

//function GetRGBColorResolvingParent: Integer;
procedure TControl_GetRGBColorResolvingParent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetRGBColorResolvingParent();
end;

//procedure InvalidatePreferredSize;
procedure TControl_InvalidatePreferredSize(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_UpdateBaseBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_BaseBounds_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PControl(Params^[0])^.BaseBounds;
end;

//Read: property ReadBounds: TRect read ReadBounds;
procedure TControl_ReadBounds_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PControl(Params^[0])^.ReadBounds;
end;

//procedure WriteLayoutDebugReport(const Prefix: string);
procedure TControl_WriteLayoutDebugReport(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.WriteLayoutDebugReport(PlpString(Params^[1])^);
end;

//function ShouldAutoAdjustLeftAndTop: Boolean;
procedure TControl_ShouldAutoAdjustLeftAndTop(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_ShouldAutoAdjustWidthAndHeight(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  // FIXME: R0b0t1 @ 11/16/17 22:05 CST.
...
procedure TControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^ := TControl.Create(PComponent(Params^[1])^);
end;

//procedure BeforeDestruction;
procedure TControl_BeforeDestruction(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.BeforeDestruction();
end;

//procedure EditingDone;
procedure TControl_EditingDone(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.EditingDone();
end;

//procedure ExecuteDefaultAction;
procedure TControl_ExecuteDefaultAction(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ExecuteDefaultAction();
end;

//procedure ExecuteCancelAction;
procedure TControl_ExecuteCancelAction(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ExecuteCancelAction();
end;

//procedure BringToFront;
procedure TControl_BringToFront(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.BringToFront();
end;

//function HasParent: Boolean;
procedure TControl_HasParent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.HasParent();
end;

//function GetParentComponent: TComponent;
procedure TControl_GetParentComponent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Result)^ := PControl(Params^[0])^.GetParentComponent();
end;

//function IsParentOf(AControl: TControl): boolean;
procedure TControl_IsParentOf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.IsParentOf(PControl(Params^[1])^);
end;

//function GetTopParent: TControl;
procedure TControl_GetTopParent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Result)^ := PControl(Params^[0])^.GetTopParent();
end;

//function IsVisible: Boolean;
procedure TControl_IsVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsVisible();
end;

//function IsControlVisible: Boolean;
procedure TControl_IsControlVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsControlVisible();
end;

//function IsEnabled: Boolean;
procedure TControl_IsEnabled(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsEnabled();
end;

//function IsParentColor: Boolean;
procedure TControl_IsParentColor(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsParentColor();
end;

//function IsParentFont: Boolean;
procedure TControl_IsParentFont(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsParentFont();
end;

//function FormIsUpdating: boolean;
procedure TControl_FormIsUpdating(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.FormIsUpdating();
end;

//function IsProcessingPaintMsg: boolean;
procedure TControl_IsProcessingPaintMsg(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.IsProcessingPaintMsg();
end;

//procedure Hide;
procedure TControl_Hide(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Hide();
end;

//procedure Refresh;
procedure TControl_Refresh(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Refresh();
end;

//procedure Repaint;
procedure TControl_Repaint(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Repaint();
end;

//procedure Invalidate;
procedure TControl_Invalidate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Invalidate();
end;

//procedure SendToBack;
procedure TControl_SendToBack(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.SendToBack();
end;

//procedure UpdateRolesForForm;
procedure TControl_UpdateRolesForForm(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.UpdateRolesForForm();
end;

//procedure ActiveDefaultControlChanged(NewControl: TControl);
procedure TControl_ActiveDefaultControlChanged(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ActiveDefaultControlChanged(PControl(Params^[1])^);
end;

//function  GetTextBuf(Buffer: PChar; BufSize: Integer): Integer;
procedure TControl_GetTextBuf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetTextBuf(PPChar(Params^[1])^, PInteger(Params^[2])^);
end;

//function  GetTextLen: Integer;
procedure TControl_GetTextLen(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetTextLen();
end;

//procedure SetTextBuf(Buffer: PChar);
procedure TControl_SetTextBuf(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.SetTextBuf(PPChar(Params^[1])^);
end;

//function  ScreenToClient(const APoint: TPoint): TPoint;
procedure TControl_ScreenToClient(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ScreenToClient(PPoint(Params^[1])^);
end;

//function  ClientToScreen(const APoint: TPoint): TPoint;
procedure TControl_ClientToScreen(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ClientToScreen(PPoint(Params^[1])^);
end;

//function  ScreenToControl(const APoint: TPoint): TPoint;
procedure TControl_ScreenToControl(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ScreenToControl(PPoint(Params^[1])^);
end;

//function  ControlToScreen(const APoint: TPoint): TPoint;
procedure TControl_ControlToScreen(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ControlToScreen(PPoint(Params^[1])^);
end;

//function GetChildsRect(Scrolled: boolean): TRect;
procedure TControl_GetChildsRect(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PControl(Params^[0])^.GetChildrenRect(Pboolean(Params^[1])^);
end;

//procedure Show;
procedure TControl_Show(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Show();
end;

//procedure Update;
procedure TControl_Update(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Update();
end;

//function HandleObjectShouldBeVisible: boolean;
procedure TControl_HandleObjectShouldBeVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.HandleObjectShouldBeVisible();
end;

//function ParentDestroyingHandle: boolean;
procedure TControl_ParentDestroyingHandle(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.ParentDestroyingHandle();
end;

//function ParentHandlesAllocated: boolean;
procedure TControl_ParentHandlesAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PControl(Params^[0])^.ParentHandlesAllocated();
end;

//procedure InitiateAction;
procedure TControl_InitiateAction(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.InitiateAction();
end;

//Read: property AutoSize: Boolean read FAutoSize write SetAutoSize default False;
procedure TControl_AutoSize_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.AutoSize;
end;

//Write: property AutoSize: Boolean read FAutoSize write SetAutoSize default False;
procedure TControl_AutoSize_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.AutoSize := PBoolean(Params^[1])^;
end;

//Read: property BoundsRect: TRect read BoundsRect write BoundsRect;
procedure TControl_BoundsRect_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PControl(Params^[0])^.BoundsRect;
end;

//Write: property BoundsRect: TRect read BoundsRect write BoundsRect;
procedure TControl_BoundsRect_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_BoundsRectForNewParent_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_BoundsRectForNewParent_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.BoundsRectForNewParent := PRect(Params^[1])^;
end;

//Read: property Caption: String read Caption write Caption;
procedure TControl_Caption_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PControl(Params^[0])^.Caption;
end;

//Write: property Caption: String read Caption write Caption;
procedure TControl_Caption_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Caption := PlpString(Params^[1])^;
end;

//Read: property ClientHeight: Integer read ClientHeight write ClientHeight;
procedure TControl_ClientHeight_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.ClientHeight;
end;

//Write: property ClientHeight: Integer read ClientHeight write ClientHeight;
procedure TControl_ClientHeight_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ClientHeight := PInteger(Params^[1])^;
end;

//Read: property ClientOrigin: TPoint read ClientOrigin;
procedure TControl_ClientOrigin_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ClientOrigin;
end;

//Read: property ClientRect: TRect read ClientRect;
procedure TControl_ClientRect_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PControl(Params^[0])^.ClientRect;
end;

//Read: property ClientWidth: Integer read ClientWidth write ClientWidth;
procedure TControl_ClientWidth_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.ClientWidth;
end;

//Write: property ClientWidth: Integer read ClientWidth write ClientWidth;
procedure TControl_ClientWidth_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ClientWidth := PInteger(Params^[1])^;
end;

//Read: property Color: Integer read Color write Color;
procedure TControl_Color_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.Color;
end;

//Write: property Color: Integer read Color write Color;
procedure TControl_Color_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Color := PInteger(Params^[1])^;
end;

//Read: property ControlOrigin: TPoint read ControlOrigin;
procedure TControl_ControlOrigin_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPoint(Result)^ := PControl(Params^[0])^.ControlOrigin;
end;

//Read: property Enabled: Boolean read Enabled write Enabled;
procedure TControl_Enabled_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.Enabled;
end;

//Write: property Enabled: Boolean read Enabled write Enabled;
procedure TControl_Enabled_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Enabled := PBoolean(Params^[1])^;
end;

//Read: property Font: TFont read Font write Font;
procedure TControl_Font_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Result)^ := PControl(Params^[0])^.Font;
end;

//Write: property Font: TFont read Font write Font;
procedure TControl_Font_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Font := PFont(Params^[1])^;
end;

//Read: property IsControl: Boolean read IsControl write IsControl;
procedure TControl_IsControl_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsControl;
end;

//Write: property IsControl: Boolean read IsControl write IsControl;
procedure TControl_IsControl_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.IsControl := PBoolean(Params^[1])^;
end;

//Read: property MouseEntered: Boolean read MouseEntered;
procedure TControl_MouseEntered_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_OnChangeBounds_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControl_OnChangeBounds_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.OnChangeBounds := PNotifyEvent(Params^[1])^;
end;

procedure TControl_OnClick_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PControl(Params^[0])^.OnClick;
end;

procedure TControl_OnClick_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.OnClick := PNotifyEvent(Params^[1])^;
end;

//Read: property OnResize: TNotifyEvent read OnResize write OnResize;
procedure TControl_OnResize_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PControl(Params^[0])^.OnResize;
end;

//Write: property OnResize: TNotifyEvent read OnResize write OnResize;
procedure TControl_OnResize_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.OnResize := PNotifyEvent(Params^[1])^;
end;

procedure TControl_Align_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PAlign(Result)^ := PControl(Params^[0])^.Align;
end;

procedure TControl_Align_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Align := PAlign(Params^[1])^;
end;

//Read: property Visible: Boolean read Visible write Visible;
procedure TControl_Visible_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.Visible;
end;

//Write: property Visible: Boolean read Visible write Visible;
procedure TControl_Visible_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Visible := PBoolean(Params^[1])^;
end;

//function UseRightToLeftAlignment: Boolean;
procedure TControl_UseRightToLeftAlignment(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftAlignment();
end;

//function UseRightToLeftReading: Boolean;
procedure TControl_UseRightToLeftReading(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftReading();
end;

//function UseRightToLeftScrollBar: Boolean;
procedure TControl_UseRightToLeftScrollBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftScrollBar();
end;

//function IsRightToLeft: Boolean;
procedure TControl_IsRightToLeft(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsRightToLeft();
end;

//Read: property Left: Integer read Left write Left;
procedure TControl_Left_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.Left;
end;

//Write: property Left: Integer read Left write Left;
procedure TControl_Left_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Left := PInteger(Params^[1])^;
end;

//Read: property Height: Integer read Height write Height;
procedure TControl_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.Height;
end;

//Write: property Height: Integer read Height write Height;
procedure TControl_Height_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Height := PInteger(Params^[1])^;
end;

//Read: property Top: Integer read Top write Top;
procedure TControl_Top_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.Top;
end;

//Write: property Top: Integer read Top write Top;
procedure TControl_Top_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Top := PInteger(Params^[1])^;
end;

//Read: property Width: Integer read Width write Width;
procedure TControl_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControl(Params^[0])^.Width;
end;

//Write: property Width: Integer read Width write Width;
procedure TControl_Width_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Width := PInteger(Params^[1])^;
end;

// Procedure ShowHint();
procedure TControl_ShowHint(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ShowHint := true;
end;

//Read: property Parent: TWinControl;
procedure TControl_Parent_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Result)^ := PControl(Params^[0])^.Parent;
end;

//Write: property Parent: TWinControl;
procedure TControl_Parent_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Parent := PWinControl(Params^[1])^;
end;

procedure TControl_Hint_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLPString(Result)^ := PControl(Params^[0])^.Hint;
end;

procedure TControl_Hint_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Hint := PLPString(Params^[1])^;
end;

procedure TControl_ShowHint_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControl(Params^[0])^.ShowHint;
end;

procedure TControl_ShowHint_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.ShowHint := PBoolean(Params^[1])^;
end;

procedure TControl_Cursor_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCursor(Result)^ := PControl(Params^[0])^.Cursor;
end;

procedure TControl_Cursor_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Params^[0])^.Cursor := PCursor(Params^[1])^;
end;

//procedure Free();
procedure TControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_BorderWidth_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PWinControl(Params^[0])^.BorderWidth;
end;

//Write: property BorderWidth: integer read BorderWidth write BorderWidth;
procedure TWinControl_BorderWidth_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.BorderWidth := Pinteger(Params^[1])^;
end;

//Read: property BoundsLockCount: integer read BoundsLockCount;
procedure TWinControl_BoundsLockCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PWinControl(Params^[0])^.BoundsLockCount;
end;

//Read: property Brush: TBrush read Brush;
procedure TWinControl_Brush_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Result)^ := PWinControl(Params^[0])^.Brush;
end;

//Read: property CachedClientHeight: integer read ClientHeight;
procedure TWinControl_CachedClientHeight_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PWinControl(Params^[0])^.CachedClientHeight;
end;

//Read: property CachedClientWidth: integer read ClientWidth;
procedure TWinControl_CachedClientWidth_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PWinControl(Params^[0])^.CachedClientWidth;
end;

//Read: property ControlCount: Integer read ControlCount;
procedure TWinControl_ControlCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_DoubleBuffered_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_DoubleBuffered_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.DoubleBuffered := PBoolean(Params^[1])^;
end;

//Read: property Handle: THandle read Handle write Handle;
procedure TWinControl_Handle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandle(Result)^ := PWinControl(Params^[0])^.Handle;
end;

//Write: property Handle: THandle read Handle write Handle;
procedure TWinControl_Handle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.Handle := PHandle(Params^[1])^;
end;

//Read: property IsResizing: Boolean read IsResizing;
procedure TWinControl_IsResizing_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.IsResizing;
end;

//Read: property TabOrder: Integer read TabOrder write Taborder ;
procedure TWinControl_TabOrder_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PWinControl(Params^[0])^.TabOrder;
end;

//Write: property TabOrder: Integer read TabOrder write Taborder ;
procedure TWinControl_TabOrder_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.TabOrder := PInteger(Params^[1])^;
end;

//Read: property TabStop: Boolean read TabStop write TabStop;
procedure TWinControl_TabStop_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.TabStop;
end;

//Write: property TabStop: Boolean read TabStop write TabStop;
procedure TWinControl_TabStop_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.TabStop := PBoolean(Params^[1])^;
end;

//Read: property OnEnter: TNotifyEvent read FOnEnter write FOnEnter;
procedure TWinControl_OnEnter_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PWinControl(Params^[0])^.OnEnter;
end;

//Write: property OnEnter: TNotifyEvent read FOnEnter write FOnEnter;
procedure TWinControl_OnEnter_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.OnEnter := PNotifyEvent(Params^[1])^;
end;

//Read: property OnExit: TNotifyEvent read FOnExit write FOnExit;
procedure TWinControl_OnExit_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PWinControl(Params^[0])^.OnExit;
end;

//Write: property OnExit: TNotifyEvent read FOnExit write FOnExit;
procedure TWinControl_OnExit_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.OnExit := PNotifyEvent(Params^[1])^;
end;

procedure TWinControl_OnKeyDown_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.OnKeyDown := PKeyEvent(Params^[1])^;
end;

procedure TWinControl_OnKeyPress_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.OnKeyPress := PKeyPressEvent(Params^[1])^;
end;

procedure TWinControl_OnKeyUp_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_ParentWindow_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_ParentWindow_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.ParentWindow := PHandle(Params^[1])^;
end;

//Read: property Showing: Boolean read Showing;
procedure TWinControl_Showing_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.Showing;
end;

//Read: property VisibleDockClientCount: Integer read VisibleDockClientCount;
procedure TWinControl_VisibleDockClientCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PWinControl(Params^[0])^.VisibleDockClientCount;
end;

//function AutoSizeDelayed: boolean;
procedure TWinControl_AutoSizeDelayed(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayed();
end;

//function AutoSizeDelayedReport: string;
procedure TWinControl_AutoSizeDelayedReport(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayedReport();
end;

//function AutoSizeDelayedHandle: Boolean;
procedure TWinControl_AutoSizeDelayedHandle(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayedHandle();
end;

//procedure BeginUpdateBounds;
procedure TWinControl_BeginUpdateBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.BeginUpdateBounds();
end;

//procedure EndUpdateBounds;
procedure TWinControl_EndUpdateBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.EndUpdateBounds();
end;

//procedure LockRealizeBounds;
procedure TWinControl_LockRealizeBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.LockRealizeBounds();
end;

//procedure UnlockRealizeBounds;
procedure TWinControl_UnlockRealizeBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.UnlockRealizeBounds();
end;

//function ControlAtPos(const Pos: TPoint; AllowDisabled: Boolean): TControl;
procedure TWinControl_ControlAtPos(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_ControlAtPosEx(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControl(Result)^ := PWinControl(Params^[0])^.ControlAtPos(PPoint(Params^[1])^, PBoolean(Params^[2])^, PBoolean(Params^[3])^);
end;

//function  ContainsControl(Control: TControl): Boolean;
procedure TWinControl_ContainsControl(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_DoAdjustClientRectChange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_InvalidateClientRectCache(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.InvalidateClientRectCache(Pboolean(Params^[1])^);
end;

//function ClientRectNeedsInterfaceUpdate: boolean;
procedure TWinControl_ClientRectNeedsInterfaceUpdate(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.ClientRectNeedsInterfaceUpdate();
end;

//procedure SetBounds(ALeft, ATop, AWidth, AHeight: integer);
procedure TWinControl_SetBounds(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.SetBounds(Pinteger(Params^[1])^, Pinteger(Params^[2])^, Pinteger(Params^[3])^, Pinteger(Params^[4])^);
end;

//function  GetChildsRect(Scrolled: boolean): TRect;
procedure TWinControl_GetChildsRect(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRect(Result)^ := PWinControl(Params^[0])^.GetChildrenRect(Pboolean(Params^[1])^);
end;

//procedure DisableAlign;
procedure TWinControl_DisableAlign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.DisableAlign();
end;

//procedure EnableAlign;
procedure TWinControl_EnableAlign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.EnableAlign();
end;

//procedure ReAlign;
procedure TWinControl_ReAlign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.ReAlign();
end;

//procedure ScrollBy(DeltaX, DeltaY: Integer);
procedure TWinControl_ScrollBy(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.ScrollBy(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure WriteLayoutDebugReport(const Prefix: string);
procedure TWinControl_WriteLayoutDebugReport(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.WriteLayoutDebugReport(PlpString(Params^[1])^);
end;

//constructor Create(TheOwner: TComponent);
procedure TWinControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^ := TWinControl.Create(PComponent(Params^[1])^);
end;

//constructor CreateParented(AParentWindow: Thandle);
procedure TWinControl_CreateParented(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^ := TWinControl.CreateParented(Phandle(Params^[1])^);
end;

//function CanFocus: Boolean;
procedure TWinControl_CanFocus(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.CanFocus();
end;

//function GetControlIndex(AControl: TControl): integer;
procedure TWinControl_GetControlIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_SetControlIndex(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.SetControlIndex(PControl(Params^[1])^, Pinteger(Params^[2])^);
end;

//function Focused: Boolean;
procedure TWinControl_Focused(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.Focused();
end;

//function PerformTab(ForwardTab: boolean): boolean;
procedure TWinControl_PerformTab(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.PerformTab(Pboolean(Params^[1])^);
end;

//function FindChildControl(const ControlName: String): TControl;
procedure TWinControl_FindChildControl(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TWinControl_SelectNext(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.SelectNext(PWinControl(Params^[1])^, PBoolean(Params^[2])^, PBoolean(Params^[3])^);
end;

//function  GetTextLen: Integer;
procedure TWinControl_GetTextLen(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PWinControl(Params^[0])^.GetTextLen();
end;

//procedure Invalidate;
procedure TWinControl_Invalidate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.Invalidate();
end;

//procedure AddControl;
procedure TWinControl_AddControl(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.AddControl();
end;

//procedure InsertControl(AControl: TControl);
procedure TWinControl_InsertControl(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.InsertControl(PControl(Params^[1])^);
end;

//procedure InsertControl(AControl: TControl; Index: integer);
procedure TWinControl_InsertControlEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.InsertControl(PControl(Params^[1])^, Pinteger(Params^[2])^);
end;

//procedure RemoveControl(AControl: TControl);
procedure TWinControl_RemoveControl(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.RemoveControl(PControl(Params^[1])^);
end;

//procedure Repaint;
procedure TWinControl_Repaint(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.Repaint();
end;

//procedure Update;
procedure TWinControl_Update(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.Update();
end;

//procedure SetFocus;
procedure TWinControl_SetFocus(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.SetFocus();
end;

//procedure FlipChildren(AllLevels: Boolean);
procedure TWinControl_FlipChildren(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.FlipChildren(PBoolean(Params^[1])^);
end;

//procedure ScaleBy(Multiplier, Divider: Integer);
procedure TWinControl_ScaleBy(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.ScaleBy(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//function GetDockCaption(AControl: TControl): String;
procedure TWinControl_GetDockCaption(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PWinControl(Params^[0])^.GetDockCaption(PControl(Params^[1])^);
end;

//procedure UpdateDockCaption(Exclude: TControl);
procedure TWinControl_UpdateDockCaption(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.UpdateDockCaption(PControl(Params^[1])^);
end;

//function HandleAllocated: Boolean;
procedure TWinControl_HandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.HandleAllocated();
end;

//function ParentHandlesAllocated: boolean;
procedure TWinControl_ParentHandlesAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.ParentHandlesAllocated();
end;

//procedure HandleNeeded;
procedure TWinControl_HandleNeeded(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.HandleNeeded();
end;

//function BrushCreated: Boolean;
procedure TWinControl_BrushCreated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.BrushCreated();
end;

//procedure PaintTo(ACanvas: TCanvas; X, Y: Integer);
procedure TWinControl_PaintTo(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.PaintTo(PCanvas(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^);
end;

//procedure SetShape(AShape: TBitmap);
procedure TWinControl_SetShape(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PWinControl(Params^[0])^.SetShape(PBitmap(Params^[1])^);
end;

//procedure Free();
procedure TWinControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomControl(Params^[0])^ := TCustomControl.Create(PComponent(Params^[1])^);
end;

//Read: property Canvas: TCanvas read Canvas write Canvas;
procedure TCustomControl_Canvas_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Result)^ := PCustomControl(Params^[0])^.Canvas;
end;

//Write: property Canvas: TCanvas read Canvas write Canvas;
procedure TCustomControl_Canvas_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomControl(Params^[0])^.Canvas := PCanvas(Params^[1])^;
end;

//Read: property OnPaint: TNotifyEvent read OnPaint write OnPaint;
procedure TCustomControl_OnPaint_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCustomControl(Params^[0])^.OnPaint;
end;

//Write: property OnPaint: TNotifyEvent read OnPaint write OnPaint;
procedure TCustomControl_OnPaint_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomControl(Params^[0])^.OnPaint := PNotifyEvent(Params^[1])^;
end;

procedure TCustomControl_BorderStyle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomControl(Params^[0])^.BorderStyle := PFormBorderStyle(Params^[1])^;
end;

//procedure Free();
procedure TCustomControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControlScrollBar_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^ := TControlScrollBar.Create(PWinControl(Params^[1])^, PScrollBarKind(Params^[2])^);
end;

//procedure Assign(Source: TPersistent);
procedure TControlScrollBar_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//function IsScrollBarVisible: Boolean;
procedure TControlScrollBar_IsScrollBarVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControlScrollBar(Params^[0])^.IsScrollBarVisible();
end;

//function ScrollPos: Integer;
procedure TControlScrollBar_ScrollPos(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.ScrollPos();
end;

//function GetOtherScrollBar: TControlScrollBar;
procedure TControlScrollBar_GetOtherScrollBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Result)^ := PControlScrollBar(Params^[0])^.GetOtherScrollBar();
end;

//Read: property Size: integer read Size;
procedure TControlScrollBar_Size_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.Size;
end;

//function ClientSize: integer;
procedure TControlScrollBar_ClientSize(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.ClientSize();
end;

//function ClientSizeWithBar: integer;
procedure TControlScrollBar_ClientSizeWithBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.ClientSizeWithBar();
end;

//function ClientSizeWithoutBar: integer;
procedure TControlScrollBar_ClientSizeWithoutBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TControlScrollBar_Increment_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.Increment;
end;

//Write: property Increment: Integer read Increment write Increment;
procedure TControlScrollBar_Increment_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Increment := PInteger(Params^[1])^;
end;

//Read: property Page: Integer read Page write Page;
procedure TControlScrollBar_Page_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.Page;
end;

//Write: property Page: Integer read Page write Page;
procedure TControlScrollBar_Page_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Page := PInteger(Params^[1])^;
end;

//Read: property Smooth: Boolean read Smooth write Smooth;
procedure TControlScrollBar_Smooth_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControlScrollBar(Params^[0])^.Smooth;
end;

//Write: property Smooth: Boolean read Smooth write Smooth;
procedure TControlScrollBar_Smooth_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Smooth := PBoolean(Params^[1])^;
end;

//Read: property Position: Integer read Position write Position;
procedure TControlScrollBar_Position_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.Position;
end;

//Write: property Position: Integer read Position write Position;
procedure TControlScrollBar_Position_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Position := PInteger(Params^[1])^;
end;

//Read: property Range: Integer read Range write Range;
procedure TControlScrollBar_Range_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.Range;
end;

//Write: property Range: Integer read Range write Range;
procedure TControlScrollBar_Range_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Range := PInteger(Params^[1])^;
end;

//Read: property Tracking: Boolean read Tracking write Tracking;
procedure TControlScrollBar_Tracking_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControlScrollBar(Params^[0])^.Tracking;
end;

//Write: property Tracking: Boolean read Tracking write Tracking;
procedure TControlScrollBar_Tracking_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Tracking := PBoolean(Params^[1])^;
end;

//Read: property Visible: Boolean read Visible write Visible;
procedure TControlScrollBar_Visible_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PControlScrollBar(Params^[0])^.Visible;
end;

//Write: property Visible: Boolean read Visible write Visible;
procedure TControlScrollBar_Visible_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PControlScrollBar(Params^[0])^.Visible := PBoolean(Params^[1])^;
end;

//procedure Free();
procedure TControlScrollBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
//constructor Create(TheOwner : TComponent);
procedure TScrollingWinControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PScrollingWinControl(Params^[0])^ := TScrollingWinControl.Create(PComponent(Params^[1])^);
end;

//procedure UpdateScrollbars;
procedure TScrollingWinControl_UpdateScrollbars(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PScrollingWinControl(Params^[0])^.UpdateScrollbars();
end;

//procedure ScrollBy(DeltaX, DeltaY: Integer);
procedure TScrollingWinControl_ScrollBy(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TScrollingWinControl_HorzScrollBar_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TScrollingWinControl_HorzScrollBar_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TScrollingWinControl_VertScrollBar_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TScrollingWinControl_VertScrollBar_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PScrollingWinControl(Params^[0])^.VertScrollBar := PControlScrollBar(Params^[1])^;
end;

//procedure Free();
procedure TScrollingWinControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TGraphicControl_Canvas_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Result)^ := PGraphicControl(Params^[0])^.Canvas;
end;

//procedure Update();
procedure TGraphicControl_Update(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphicControl(Params^[0])^.Update();
end;

procedure TGraphicControl_Align_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PAlign(Result)^ := PGraphicControl(Params^[0])^.Align;
end;

procedure TGraphicControl_Align_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
