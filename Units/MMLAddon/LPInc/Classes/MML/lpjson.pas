...
begin
  ...
  begin
    ...
    addGlobalFunc('function TJSONArray.put( value : double ): TJSONArray;   overload; overload;', @TJSONArray_putEx);
    addGlobalFunc('function TJSONArray.put( value : integer): TJSONArray;   overload; overload;', @TJSONArray_putExEx);
    addGlobalFunc('function TJSONArray.put( value : pointer): TJSONArray;  overload; overload;', @TJSONArray_putExExEx);
    addGlobalFunc('function TJSONArray.put( value: string): TJSONArray; overload;', @TJSONArray_putExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : boolean): TJSONArray;  overload; overload;', @TJSONArray_putExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : double): TJSONArray;  overload; overload;', @TJSONArray_putExExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : integer): TJSONArray;  overload; overload;', @TJSONArray_putExExExExExExEx);
    addGlobalFunc('function TJSONArray.put( index : integer ; value : pointer): TJSONArray;  overload; overload;', @TJSONArray_putExExExExExExExEx);
