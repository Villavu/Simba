...
procedure TMMLSettingsSandbox_Init(const Params: PParamArray); lape_extdecl
begin
  PMMLSettingsSandbox(Params^[0])^ := TMMLSettingsSandbox.Create(PMMLSettings(Params^[1])^);
end;

//function IsKey(const KeyName: String): Boolean;
procedure TMMLSettingsSandbox_IsKey(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
  PBoolean(Result)^ := PMMLSettingsSandbox(Params^[0])^.IsKey(PlpString(Params^[1])^);
end;

//function IsDirectory(const KeyName: String): Boolean;
procedure TMMLSettingsSandbox_IsDirectory(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_SetKeyValue(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_GetKeyValue(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_GetKeyValueDef(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_ListKeys(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_DeleteKey(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_DeleteSubKeys(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMMLSettingsSandbox_prefix_Read(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
  PlpString(Result)^ := PMMLSettingsSandbox(Params^[0])^.prefix;
end;

//Write: property prefix : string read GetPrefix write SetPrefix;
procedure TMMLSettingsSandbox_prefix_Write(const Params: PParamArray); lape_extdecl
begin
  PMMLSettingsSandbox(Params^[0])^.prefix := PlpString(Params^[1])^;
end;

//procedure Free();
procedure TMMLSettingsSandbox_Free(const Params: PParamArray); lape_extdecl
begin
