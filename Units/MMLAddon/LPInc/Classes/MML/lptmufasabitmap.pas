...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TMufasaBitmap.ValidatePoint(x,y : integer);', @TMufasaBitmap_ValidatePoint);
    ...
    addGlobalFunc('procedure TMufasaBitmap.Rectangle(const Box: TBox; const Color: Integer; const Transparency: Extended); overload;', @TMufasaBitmap_RectangleEx);
    ...
    addGlobalFunc('procedure TMufasaBitmap.SetPixel(x,y : integer; Color : TColor);', @TMufasaBitmap_FastSetPixel);
    ...
    addGlobalFunc('function TMufasaBitmap.GetHSLValues(xs, ys, xe, ye: integer): T2DHSLArray;', @TMufasaBitmap_GetHSLValues);
    addGlobalFunc('procedure TMufasaBitmap.DrawClear(Color : TColor);', @TMufasaBitmap_FastDrawClear);
    addGlobalFunc('procedure TMufasaBitmap.DrawTransparent(x, y: Integer; TargetBitmap: TMufasaBitmap);', @TMufasaBitmap_FastDrawTransparent);
    ...
    addGlobalFunc('procedure TMufasaBitmap.Brightness(TargetBitmap : TMufasaBitmap; br : integer);', @TMufasaBitmap_Brightness);
    addGlobalFunc('procedure TMufasaBitmap.Brightness(br: integer); overload;', @TMufasaBitmap_BrightnessEx);
    addGlobalFunc('procedure TMufasaBitmap.Contrast(TargetBitmap : TMufasaBitmap; co : Extended);', @TMufasaBitmap_Contrast);
    addGlobalFunc('procedure TMufasaBitmap.Contrast(co: Extended); overload;', @TMufasaBitmap_ContrastEx);
    addGlobalFunc('procedure TMufasaBitmap.Invert(TargetBitmap : TMufasaBitmap);', @TMufasaBitmap_Invert);
    ...
    addGlobalFunc('procedure TMufasaBitmap.DrawText(const Text, FontName: string; const pnt: TPoint; const Shadow: Boolean; const Color: Integer);', @TMufasaBitmap_DrawText);
    addGlobalFunc('procedure TMufasaBitmap.DrawSystemText(const Text, FontName: string; const FontSize: Integer; const pnt: TPoint; const Shadow: Boolean; const Color: Integer);', @TMufasaBitmap_DrawSystemText);
