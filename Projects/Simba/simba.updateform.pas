...
uses
  Classes, SysUtils, FileUtil, LResources, Forms, simba.MufasaBase, Controls, Graphics, Dialogs,
  ComCtrls, StdCtrls, simba.updater;
...
uses
  lclintf,
  simba.main, simba.settings;

function TSimbaUpdateForm.CanUpdate: Boolean;
begin
  GetLatestSimbaVersion;
  WriteLn(format('Current Simba version: %d',[SimbaVersion]));
