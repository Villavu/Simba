...
uses
  Classes, SysUtils, package_sockets, package_ssockets, package_openssl, package_fpopenssl;
...
begin
  if not IsSSLloaded then
    if not InitSSLInterface and (not IsSSLloaded) then
