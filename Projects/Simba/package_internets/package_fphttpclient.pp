...
uses
  Classes, SysUtils, package_ssockets, httpdefs, uriparser, base64;
...
begin
  ...
  begin
    e := EHTTPClient.CreateFmt(SErrUnexpectedResponse,[ResponseStatusCode]);
    e.StatusCode := FResponseStatusCode;
