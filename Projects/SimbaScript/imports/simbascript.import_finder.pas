...
begin
  with Script.Client do // bitmap                     out TPA                   formula                  xs                  ys                  xe                  ye                  min match              dynamic adjust
...
begin
  with Script.Client do // bitmap                   out X               out Y               formula                  xs                  ys,                 xe                  ye                  min match              dynamic adjust
...
initialization
  RegisterScriptImport(@Lape_Import_Finder);
