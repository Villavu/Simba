...
begin
  PInt32(Result)^ := ScriptInstance.Client.MInternets.CreateHTTPClient(PBoolean(Params^[0])^);
end;

procedure Lape_FreeHTTPClient(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.FreeHTTPClient(PInt32(Params^[0])^);
end;

procedure Lape_GetHTTPPage(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).GetHTTPPage(PString(Params^[1])^);
end;

procedure Lape_SetHTTPUserAgent(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).UserAgent := PString(Params^[1])^;
end;

procedure Lape_PostHTTPPage(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).PostHTTPPage(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_PostHTTPPageEx(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).PostHTTPPage(PString(Params^[1])^);
end;

procedure Lape_ClearPostData(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).ClearPostData();
end;

procedure Lape_AddPostVariable(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).AddPostVariable(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_GetRawHeaders(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).Headers;
end;

procedure Lape_SetProxy(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).SetProxy(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_RecvSocketStr(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).RecvString();
end;

procedure Lape_RecvSocket(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Recv();
end;

procedure Lape_RecvSocketEx(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).RecvBufferStr(PInt32(Params^[1])^);
end;

procedure Lape_SendSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Send(PString(Params^[1])^);
end;

procedure Lape_ConnectSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Connect(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_CloseSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Close();
end;

procedure Lape_SetSocketTimeout(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).SetTimeout(PInt32(Params^[1])^);
end;

procedure Lape_BindSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Bind(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_ListenSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Listen();
end;
...
begin
   ScriptInstance.Client.MSockets.GetSocket(PInt32(Params^[0])^).Info(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_CreateSocket(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt32(Result)^ := ScriptInstance.Client.MSockets.CreateSocket();
end;

procedure Lape_FreeSocket(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MSockets.FreeSocket(PInt32(Params^[0])^);
end;

procedure Lape_GetHTTPResponseCode(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt32(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).ResponseCode;
end;

procedure Lape_GetHTTPPageEx(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt32(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).GetHTTPPage(PString(Params^[1])^, PString(Params^[2])^);
end;

procedure Lape_GetHTTPUserAgent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).UserAgent;
end;

procedure Lape_SetHTTPContentType(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).RequestContentType := PString(Params^[1])^;
end;

procedure Lape_SetHTTPHeader(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).RequestHeader[PString(Params^[1])^] := PString(Params^[2])^;
end;

procedure Lape_FormPost(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).FormPost(PString(Params^[1])^, PString(Params^[2])^, PString(Params^[3])^);
end;
...
type
  PStream = ^TStream;
begin
  PString(Result)^ := ScriptInstance.Client.MInternets.GetHTTPClient(PInt32(Params^[0])^).FormPost(PString(Params^[1])^, PString(Params^[2])^, PString(Params^[3])^, PStream(Params^[4])^);
end;
