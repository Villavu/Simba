...
procedure TLCLComponent_RemoveAllHandlersOfObject(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLCLComponent(Params^[0])^.RemoveAllHandlersOfObject(PObject(Params^[1])^);
end;

//procedure IncLCLRefCount;
procedure TLCLComponent_IncLCLRefCount(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLCLComponent(Params^[0])^.IncLCLRefCount();
end;

//procedure DecLCLRefCount;
procedure TLCLComponent_DecLCLRefCount(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLCLComponent(Params^[0])^.DecLCLRefCount();
end;

//Read: property LCLRefCount: integer read FLCLRefCount;
procedure TLCLComponent_LCLRefCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PLCLComponent(Params^[0])^.LCLRefCount;
end;

//constructor Create();
procedure TLCLComponent_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
 PLCLComponent(Params^[0])^ := TLCLComponent.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TLCLComponent_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
Procedure TCommonDialog_FCompStyle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongInt(Result)^ := PCommonDialog(Params^[0])^.FCompStyle;
end;

//Write: FCompStyle : LongInt;
procedure TCommonDialog_FCompStyle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.FCompStyle := PLongInt(Params^[1])^;
end;

//function Execute: boolean; virtual;
procedure TCommonDialog_Execute(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCommonDialog(Params^[0])^.Execute();
end;

//Read: property Handle: THandle read FHandle write SetHandle;
procedure TCommonDialog_Handle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandle(Result)^ := PCommonDialog(Params^[0])^.Handle;
end;

//Write: property Handle: THandle read FHandle write SetHandle;
procedure TCommonDialog_Handle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.Handle := PHandle(Params^[1])^;
end;

//Read: property UserChoice: integer read FUserChoice write FUserChoice;
procedure TCommonDialog_UserChoice_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCommonDialog(Params^[0])^.UserChoice;
end;

//Write: property UserChoice: integer read FUserChoice write FUserChoice;
procedure TCommonDialog_UserChoice_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.UserChoice := Pinteger(Params^[1])^;
end;

//procedure Close; virtual;
procedure TCommonDialog_Close(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.Close();
End;

//procedure DoShow; virtual;
procedure TCommonDialog_DoShow(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.DoShow();
end;

//procedure DoCanClose(var CanClose: Boolean); virtual;
procedure TCommonDialog_DoCanClose(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.DoCanClose(PBoolean(Params^[1])^);
end;

//procedure DoClose; virtual;
procedure TCommonDialog_DoClose(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.DoClose();
end;

//function HandleAllocated: boolean;
procedure TCommonDialog_HandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCommonDialog(Params^[0])^.HandleAllocated();
end;

//Read: property OnClose: TNotifyEvent read FOnClose write FOnClose;
procedure TCommonDialog_OnClose_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCommonDialog(Params^[0])^.OnClose;
end;

//Write: property OnClose: TNotifyEvent read FOnClose write FOnClose;
procedure TCommonDialog_OnClose_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCommonDialog_OnCanClose_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCommonDialog_OnCanClose_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.OnCanClose := PCloseQueryEvent(Params^[1])^;
end;

//Read: property OnShow: TNotifyEvent read FOnShow write FOnShow;
procedure TCommonDialog_OnShow_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCommonDialog(Params^[0])^.OnShow;
end;

//Write: property OnShow: TNotifyEvent read FOnShow write FOnShow;
procedure TCommonDialog_OnShow_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.OnShow := PNotifyEvent(Params^[1])^;
end;

//Read: property Width: integer read FWidth write SetWidth default 0;
procedure TCommonDialog_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCommonDialog(Params^[0])^.Width;
end;

//Write: property Width: integer read FWidth write SetWidth default 0;
procedure TCommonDialog_Width_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.Width := Pinteger(Params^[1])^;
end;

//Read: property Height: integer read FHeight write SetHeight default 0;
procedure TCommonDialog_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCommonDialog(Params^[0])^.Height;
end;

//Write: property Height: integer read FHeight write SetHeight default 0;
procedure TCommonDialog_Height_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^.Height := Pinteger(Params^[1])^;
end;

//constructor Create();
procedure TCommonDialog_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCommonDialog(Params^[0])^ := TCommonDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCommonDialog_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_DoTypeChange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.DoTypeChange();
end;

//function Execute: boolean; override;
procedure TFileDialog_Execute(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
Begin
  Pboolean(Result)^ := PFileDialog(Params^[0])^.Execute();
end;

//Read: property Files: TStrings read FFiles;
procedure TFileDialog_Files_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Result)^ := PFileDialog(Params^[0])^.Files;
end;

//Read: property HistoryList: TStrings read FHistoryList write SetHistoryList;
procedure TFileDialog_HistoryList_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_HistoryList_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.HistoryList := PStrings(Params^[1])^;
end;

//procedure IntfFileTypeChanged(NewFilterIndex: Integer);
procedure TFileDialog_IntfFileTypeChanged(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_DefaultExt_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFileDialog(Params^[0])^.DefaultExt;
end;

//Write: property DefaultExt: string read FDefaultExt write SetDefaultExt;
procedure TFileDialog_DefaultExt_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.DefaultExt := PlpString(Params^[1])^;
end;

//Read: property FileName: String read FFileName write SetFileName;
procedure TFileDialog_FileName_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFileDialog(Params^[0])^.FileName;
end;

//Write: property FileName: String read FFileName write SetFileName;
procedure TFileDialog_FileName_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.FileName := PlpString(Params^[1])^;
end;

//Read: property Filter: String read FFilter write SetFilter;
procedure TFileDialog_Filter_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFileDialog(Params^[0])^.Filter;
end;

//Write: property Filter: String read FFilter write SetFilter;
procedure TFileDialog_Filter_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_FilterIndex_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_FilterIndex_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.FilterIndex := PInteger(Params^[1])^;
end;

//Read: property InitialDir: string read FInitialDir write FInitialDir;
procedure TFileDialog_InitialDir_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFileDialog(Params^[0])^.InitialDir;
end;

//Write: property InitialDir: string read FInitialDir write FInitialDir;
procedure TFileDialog_InitialDir_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_OnHelpClicked_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_OnHelpClicked_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_OnTypeChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileDialog_OnTypeChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^.OnTypeChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TFileDialog_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileDialog(Params^[0])^ := TFileDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TFileDialog_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_DoFolderChange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  POpenDialog(Params^[0])^.DoFolderChange();
end;

//procedure DoSelectionChange; virtual;
procedure TOpenDialog_DoSelectionChange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  POpenDialog(Params^[0])^.DoSelectionChange();
end;

//procedure IntfSetOption(const AOption: TOpenOption; const AValue: Boolean);
procedure TOpenDialog_IntfSetOption(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_Options_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_Options_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_OnFolderChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
Begin
...
procedure TOpenDialog_OnFolderChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_OnSelectionChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TOpenDialog_OnSelectionChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  POpenDialog(Params^[0])^.OnSelectionChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TOpenDialog_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  POpenDialog(Params^[0])^ := TOpenDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TOpenDialog_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TColorDialog_Color_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColor(Result)^ := PColorDialog(Params^[0])^.Color;
end;

//Write: property Color: TColor read FColor write FColor;
procedure TColorDialog_Color_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColorDialog(Params^[0])^.Color := PColor(Params^[1])^;
end;

//Read: property CustomColors: TStrings read FCustomColors write SetCustomColors;
procedure TColorDialog_CustomColors_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TColorDialog_CustomColors_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColorDialog(Params^[0])^.CustomColors := PStrings(Params^[1])^;
end;

//constructor Create();
procedure TColorDialog_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColorDialog(Params^[0])^ := TColorDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TColorDialog_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
