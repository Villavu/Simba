...
//procedure StepIt;
procedure TCustomProgressBar_StepIt(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomProgressBar(Params^[0])^.StepIt();
end;

//procedure StepBy(Delta: Integer);
procedure TCustomProgressBar_StepBy(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomProgressBar(Params^[0])^.StepBy(PInteger(Params^[1])^);
end;

//Read: property Max: Integer read GetMax write SetMax default 100;
procedure TCustomProgressBar_Max_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomProgressBar(Params^[0])^.Max;
end;

//Write: property Max: Integer read GetMax write SetMax default 100;
procedure TCustomProgressBar_Max_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomProgressBar(Params^[0])^.Max := PInteger(Params^[1])^;
end;

//Read: property Min: Integer read GetMin write SetMin default 0;
procedure TCustomProgressBar_Min_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomProgressBar(Params^[0])^.Min;
end;

//Write: property Min: Integer read GetMin write SetMin default 0;
procedure TCustomProgressBar_Min_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Orientation_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Orientation_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Position_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Position_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Smooth_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Smooth_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomProgressBar(Params^[0])^.Smooth := Pboolean(Params^[1])^;
end;

//Read: property Step: Integer read FStep write SetStep default 10;
procedure TCustomProgressBar_Step_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomProgressBar(Params^[0])^.Step;
end;

//Write: property Step: Integer read FStep write SetStep default 10;
procedure TCustomProgressBar_Step_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Style_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_Style_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_BarShowText_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomProgressBar_BarShowText_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomProgressBar(Params^[0])^.BarShowText := Pboolean(Params^[1])^;
end;

//procedure Free();
procedure TCustomProgressBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCustomProgressBar.Init(AOwner: TComponent); override;', @TCustomProgressBar_Init);
...
//constructor Create();
procedure TProgressBar_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PProgressBar(Params^[0])^ := TProgressBar.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TProgressBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TProgressBar.Init(AOwner: TComponent); override;', @TProgressBar_Init);
    //addGlobalFunc('procedure TProgressBar.Free(); constref;', @TProgressBar_Free);
  end;
end;

//constructor Create();
procedure TCustomTrackBar_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^ := TCustomTrackBar.Create(PComponent(Params^[1])^);
end;

//procedure SetTick(Value: Integer);
procedure TCustomTrackBar_SetTick(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Frequency_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Frequency_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_LineSize_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_LineSize_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^.LineSize := PInteger(Params^[1])^;
end;

//Read: property Max: Integer read FMax write SetMax default 10;
procedure TCustomTrackBar_Max_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomTrackBar(Params^[0])^.Max;
end;

//Write: property Max: Integer read FMax write SetMax default 10;
procedure TCustomTrackBar_Max_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^.Max := PInteger(Params^[1])^;
end;

//Read: property Min: Integer read FMin write SetMin default 0;
procedure TCustomTrackBar_Min_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomTrackBar(Params^[0])^.Min;
end;

//Write: property Min: Integer read FMin write SetMin default 0;
procedure TCustomTrackBar_Min_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^.Min := PInteger(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TCustomTrackBar_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCustomTrackBar(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TCustomTrackBar_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Orientation_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Orientation_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_PageSize_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_PageSize_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^.PageSize := PInteger(Params^[1])^;
end;

//Read: property Position: Integer read FPosition write SetPosition;
procedure TCustomTrackBar_Position_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomTrackBar(Params^[0])^.Position;
end;

//Write: property Position: Integer read FPosition write SetPosition;
procedure TCustomTrackBar_Position_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Reversed_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_Reversed_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_ScalePos_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_ScalePos_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_SelEnd_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomTrackBar(Params^[0])^.SelEnd;
end;

//Write: property SelEnd: Integer read FSelEnd write SetSelEnd default 0;
procedure TCustomTrackBar_SelEnd_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_SelStart_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_SelStart_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_ShowSelRange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_ShowSelRange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_TickMarks_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_TickMarks_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_TickStyle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTrackBar_TickStyle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTrackBar(Params^[0])^.TickStyle := PTickStyle(Params^[1])^;
end;

//procedure Free();
procedure TCustomTrackBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCustomTrackBar.Init(AOwner: TComponent); override;', @TCustomTrackBar_Init);
...
//constructor Create();
procedure TTrackBar_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PTrackBar(Params^[0])^ := TTrackBar.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TTrackBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TTrackBar.Init(AOwner: TComponent); override;', @TTrackBar_Init);
...
procedure TCustomCheckListBox_MeasureItem(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomCheckListBox(Params^[0])^.MeasureItem(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure Toggle(AIndex: Integer);
procedure TCustomCheckListBox_Toggle(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_CheckAll(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_AllowGrayed_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_AllowGrayed_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_Checked_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_Checked_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_ItemEnabled_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_ItemEnabled_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_State_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_State_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomCheckListBox(Params^[0])^.State[PInteger(Params^[1])^] := PCheckBoxState(Params^[1])^;
end;

//Read: property Count: integer read GetCount;
procedure TCustomCheckListBox_Count_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_OnClickCheck_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomCheckListBox_OnClickCheck_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomCheckListBox(Params^[0])^.OnClickCheck := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TCustomCheckListBox_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomCheckListBox(Params^[0])^ := TCustomCheckListBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomCheckListBox_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomCheckListBox(Params^[0])^.Free();
end;

procedure TCustomCheckListBox_OnCheckListClicked_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
//constructor Create();
procedure TCheckListBox_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCheckListBox(Params^[0])^ := TCheckListBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCheckListBox_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCheckListBox.Init(AOwner: TComponent); override;', @TCheckListBox_Init);
...
procedure TCustomPage_CanTab(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCustomPage(Params^[0])^.CanTab();
end;

//function IsControlVisible: Boolean; override;
procedure TCustomPage_IsControlVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PCustomPage(Params^[0])^.IsControlVisible();
end;

//function HandleObjectShouldBeVisible: boolean; override;
procedure TCustomPage_HandleObjectShouldBeVisible(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCustomPage(Params^[0])^.HandleObjectShouldBeVisible();
end;

//function VisibleIndex: integer; virtual;
procedure TCustomPage_VisibleIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCustomPage(Params^[0])^.VisibleIndex();
end;

//Read: property PageIndex: Integer read GetPageIndex write SetPageIndex;
procedure TCustomPage_PageIndex_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCustomPage(Params^[0])^.PageIndex;
end;

//Write: property PageIndex: Integer read GetPageIndex write SetPageIndex;
procedure TCustomPage_PageIndex_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomPage_TabVisible_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomPage_TabVisible_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Params^[0])^.TabVisible := PBoolean(Params^[1])^;
end;

//Read: property OnHide: TNotifyEvent read FOnHide write FOnHide;
procedure TCustomPage_OnHide_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCustomPage(Params^[0])^.OnHide;
end;

//Write: property OnHide: TNotifyEvent read FOnHide write FOnHide;
procedure TCustomPage_OnHide_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Params^[0])^.OnHide := PNotifyEvent(Params^[1])^;
end;

//Read: property OnShow: TNotifyEvent read FOnShow write FOnShow;
procedure TCustomPage_OnShow_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCustomPage(Params^[0])^.OnShow;
end;

//Write: property OnShow: TNotifyEvent read FOnShow write FOnShow;
procedure TCustomPage_OnShow_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Params^[0])^.OnShow := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TCustomPage_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Params^[0])^ := TCustomPage.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomPage_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCustomPage.Init(TheOwner: TComponent); override;', @TCustomPage_Init);
...
procedure TCustomTabControl_GetImageIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_IndexOf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCustomTabControl(Params^[0])^.IndexOf(PPersistent(Params^[1])^);
end;

//function CustomPage(Index: integer): TCustomPage;
procedure TCustomTabControl_CustomPage(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Result)^ := PCustomTabControl(Params^[0])^.CustomPage(Pinteger(Params^[1])^);
end;

//function CanChangePageIndex: boolean; virtual;
procedure TCustomTabControl_CanChangePageIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCustomTabControl(Params^[0])^.CanChangePageIndex();
end;

//function GetMinimumTabWidth: integer; virtual;
procedure TCustomTabControl_GetMinimumTabWidth(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCustomTabControl(Params^[0])^.GetMinimumTabWidth();
end;

//function GetMinimumTabHeight: integer; virtual;
procedure TCustomTabControl_GetMinimumTabHeight(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCustomTabControl(Params^[0])^.GetMinimumTabHeight();
end;

//function TabToPageIndex(AIndex: integer): integer;
procedure TCustomTabControl_TabToPageIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_PageToTabIndex(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCustomTabControl(Params^[0])^.PageToTabIndex(Pinteger(Params^[1])^);
end;

//function IndexOfTabAt(X, Y: Integer): Integer;
procedure TCustomTabControl_IndexOfTabAt(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_DoCloseTabClicked(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_MultiLine_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_MultiLine_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_OnChanging_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_OnChanging_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_Options_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_Options_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTabControl(Params^[0])^.Options := PCTabControlOptions(Params^[1])^;
end;

//Read: property Page[Index: Integer]: TCustomPage read GetPage;
procedure TCustomTabControl_Page_Index_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomPage(Result)^ := PCustomTabControl(Params^[0])^.Page[PInteger(Params^[1])^];
end;

//Read: property PageCount: integer read GetPageCount;
procedure TCustomTabControl_PageCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_PageIndex_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_PageIndex_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTabControl(Params^[0])^.PageIndex := PInteger(Params^[1])^;
end;

//Read: property Pages: TStrings read FAccess write SetPages;
procedure TCustomTabControl_Pages_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Result)^ := PCustomTabControl(Params^[0])^.Pages;
end;

//Write: property Pages: TStrings read FAccess write SetPages;
procedure TCustomTabControl_Pages_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_ShowTabs_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_ShowTabs_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_TabPosition_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomTabControl_TabPosition_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTabControl(Params^[0])^.TabPosition := PTabPosition(Params^[1])^;
end;

//Read: property IsUnpaged: boolean read FUnPaged;
procedure TCustomTabControl_IsUnpaged_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  // FIXME: R0b0t1 @ 11/16/17 22:05 CST.
...
//constructor Create();
procedure TCustomTabControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomTabControl(Params^[0])^ := TCustomTabControl.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomTabControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCustomTabControl.Init(TheOwner: TComponent); override;', @TCustomTabControl_Init);
...
procedure TTabSheet_TabIndex_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PTabSheet(Params^[0])^.TabIndex;
end;

//constructor Create();
procedure TTabSheet_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PTabSheet(Params^[0])^ := TTabSheet.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TTabSheet_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TTabSheet.Init(TheOwner: TComponent); override;', @TTabSheet_Init);
    //addGlobalFunc('procedure TTabSheet.Free(); constref;', @TTabSheet_Free);
  end;
end;

//procedure SelectNextPage(GoForward: Boolean);
procedure TPageControl_SelectNextPage(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPageControl(Params^[0])^.SelectNextPage(PBoolean(Params^[1])^);
end;

//procedure SelectNextPage(GoForward: Boolean; CheckTabVisible: Boolean);
procedure TPageControl_SelectNextPageEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPageControl(Params^[0])^.SelectNextPage(PBoolean(Params^[1])^, PBoolean(Params^[2])^);
end;

//function AddTabSheet: TTabSheet;
procedure TPageControl_AddTabSheet(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PTabSheet(Result)^ := PPageControl(Params^[0])^.AddTabSheet();
end;

//Read: property Pages[Index: Integer]: TTabSheet read GetTabSheet;
procedure TPageControl_Pages_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TPageControl_ActivePage_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TPageControl_ActivePage_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPageControl(Params^[0])^.ActivePage := PTabSheet(Params^[1])^;
end;

//constructor Create();
procedure TPageControl_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPageControl(Params^[0])^ := TPageControl.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TPageControl_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TPageControl.Init(TheOwner: TComponent); override;', @TPageControl_Init);
...
procedure TStatusPanel_StatusBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Alignment_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Alignment_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Bevel_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Bevel_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Style_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanel_Style_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanel(Params^[0])^.Style := PStatusPanelStyle(Params^[1])^;
end;

//Read: property Text: TCaption read FText write SetText;
procedure TStatusPanel_Text_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
 PLPString(Result)^ := PStatusPanel(Params^[0])^.Text;
end;

//Write: property Text: TCaption read FText write SetText;
procedure TStatusPanel_Text_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanel(Params^[0])^.Text := PCaption(Params^[1])^;
end;

//Read: property Width: Integer read FWidth write SetWidth;
procedure TStatusPanel_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStatusPanel(Params^[0])^.Width;
end;

//Write: property Width: Integer read FWidth write SetWidth;
procedure TStatusPanel_Width_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanel(Params^[0])^.Width := PInteger(Params^[1])^;
end;

//constructor Create();
procedure TStatusPanel_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanel(Params^[0])^ := TStatusPanel.Create(PCollection(Params^[1])^);
end;

//procedure Free();
procedure TStatusPanel_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TStatusPanel.Init(ACollection: TCollection); override;', @TStatusPanel_Init);
    //addGlobalFunc('procedure TStatusPanel.Free(); constref;', @TStatusPanel_Free);
  end;
end;

//constructor Create(AStatusBar: TStatusBar);
procedure TStatusPanels_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanels(Params^[0])^ := TStatusPanels.Create(PStatusBar(Params^[1])^);
end;

//function Add: TStatusPanel;
procedure TStatusPanels_Add(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanels_Items_Index_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusPanels_Items_Index_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanels(Params^[0])^.Items[PInteger(Params^[1])^] := PStatusPanel(Params^[2])^;
end;

//Read: property StatusBar: TStatusBar read FStatusBar;
procedure TStatusPanels_StatusBar_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Result)^ := PStatusPanels(Params^[0])^.StatusBar;
end;

//procedure Free();
procedure TStatusPanels_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusBar_InvalidatePanel(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.InvalidatePanel(Pinteger(Params^[1])^, PPanelParts(Params^[2])^);
end;

//procedure BeginUpdate;
procedure TStatusBar_BeginUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.BeginUpdate();
end;

//procedure EndUpdate;
procedure TStatusBar_EndUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.EndUpdate();
end;

//function GetPanelIndexAt(X, Y: Integer): Integer;
procedure TStatusBar_GetPanelIndexAt(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStatusBar(Params^[0])^.GetPanelIndexAt(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//function SizeGripEnabled: Boolean;
procedure TStatusBar_SizeGripEnabled(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStatusBar(Params^[0])^.SizeGripEnabled();
end;

//function UpdatingStatusBar: boolean;
procedure TStatusBar_UpdatingStatusBar(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PStatusBar(Params^[0])^.UpdatingStatusBar();
end;

//Read: property Canvas: TCanvas read FCanvas;
procedure TStatusBar_Canvas_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Result)^ := PStatusBar(Params^[0])^.Canvas;
end;

//Read: property AutoHint: Boolean read FAutoHint write FAutoHint default false;
procedure TStatusBar_AutoHint_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStatusBar(Params^[0])^.AutoHint;
end;

//Write: property AutoHint: Boolean read FAutoHint write FAutoHint default false;
procedure TStatusBar_AutoHint_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.AutoHint := PBoolean(Params^[1])^;
end;

//Read: property Panels: TStatusPanels read FPanels write SetPanels;
procedure TStatusBar_Panels_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusPanels(Result)^ := PStatusBar(Params^[0])^.Panels;
end;

//Write: property Panels: TStatusPanels read FPanels write SetPanels;
procedure TStatusBar_Panels_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.Panels := PStatusPanels(Params^[1])^;
end;

//Read: property SimpleText: TCaption read FSimpleText write SetSimpleText;
procedure TStatusBar_SimpleText_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCaption(Result)^ := PStatusBar(Params^[0])^.SimpleText;
end;

//Write: property SimpleText: TCaption read FSimpleText write SetSimpleText;
procedure TStatusBar_SimpleText_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusBar_SimplePanel_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusBar_SimplePanel_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusBar_SizeGrip_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStatusBar_SizeGrip_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.SizeGrip := PBoolean(Params^[1])^;
end;

//Read: property OnHint: TNotifyEvent read FOnHint write FOnHint;
procedure TStatusBar_OnHint_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PStatusBar(Params^[0])^.OnHint;
end;

//Write: property OnHint: TNotifyEvent read FOnHint write FOnHint;
procedure TStatusBar_OnHint_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^.OnHint := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TStatusBar_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStatusBar(Params^[0])^ := TStatusBar.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TStatusBar_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TStatusBar.Init(TheOwner: TComponent); override;', @TStatusBar_Init);
