...
procedure TPersistent_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPersistent(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//function  GetNamePath: string;
procedure TPersistent_GetNamePath(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PPersistent(Params^[0])^.GetNamePath();
end;

//constructor Create();
procedure TPersistent_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPersistent(Params^[0])^ := TPersistent.Create();
end;

//procedure Free();
procedure TPersistent_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TPersistent.Init(); override;', @TPersistent_Init);
...
procedure TStream_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PStream(Params^[0])^.Read(PLongint(Params^[1])^,PLongint(Params^[2])^);
end;

//function Write(const Buffer; Count: Longint): Longint;
procedure TStream_Write(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PStream(Params^[0])^.Write(PLongint(Params^[1])^,PLongint(Params^[2])^);
end;

//function Seek(Offset: Longint; Origin: Word): Longint;
procedure TStream_Seek(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PStream(Params^[0])^.Seek(PLongint(Params^[1])^, PWord(Params^[2])^);
end;

//procedure ReadBuffer(var Buffer; Count: Longint);
procedure TStream_ReadBuffer(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.ReadBuffer(PLongint(Params^[1])^,PLongint(Params^[2])^);
end;

//procedure WriteBuffer(const Buffer; Count: Longint);
procedure TStream_WriteBuffer(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteBuffer(PLongint(Params^[1])^,PLongint(Params^[2])^);
end;

//function CopyFrom(Source: TStream; Count: Int64): Int64;
procedure TStream_CopyFrom(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt64(Result)^ := PStream(Params^[0])^.CopyFrom(PStream(Params^[1])^, PInt64(Params^[2])^);
end;

//function ReadComponent(Instance: TComponent): TComponent;
procedure TStream_ReadComponent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Result)^ := PStream(Params^[0])^.ReadComponent(PComponent(Params^[1])^);
end;

//function ReadComponentRes(Instance: TComponent): TComponent;
procedure TStream_ReadComponentRes(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Result)^ := PStream(Params^[0])^.ReadComponentRes(PComponent(Params^[1])^);
end;

//procedure WriteComponent(Instance: TComponent);
procedure TStream_WriteComponent(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteComponent(PComponent(Params^[1])^);
end;

//procedure WriteComponentRes(const ResName: string; Instance: TComponent);
procedure TStream_WriteComponentRes(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteComponentRes(PlpString(Params^[1])^, PComponent(Params^[2])^);
end;

//procedure WriteDescendent(Instance, Ancestor: TComponent);
procedure TStream_WriteDescendent(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteDescendent(PComponent(Params^[1])^, PComponent(Params^[2])^);
end;

//procedure WriteDescendentRes(const ResName: string; Instance, Ancestor: TComponent);
procedure TStream_WriteDescendentRes(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStream_WriteResourceHeader(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteResourceHeader(PlpString(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure FixupResourceHeader(FixupInfo: Integer);
procedure TStream_FixupResourceHeader(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.FixupResourceHeader(PInteger(Params^[1])^);
end;

//procedure ReadResHeader;
procedure TStream_ReadResHeader(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.ReadResHeader();
end;

//function ReadByte : Byte;
procedure TStream_ReadByte(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PByte(Result)^ := PStream(Params^[0])^.ReadByte();
end;

//function ReadDWord : UInt32;
procedure TStream_ReadDWord(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PUInt32(Result)^ := PStream(Params^[0])^.ReadDWord();
end;

//function ReadAnsiString : String;
procedure TStream_ReadAnsiString(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStream(Params^[0])^.ReadAnsiString();
end;

//procedure WriteByte(b : Byte);
procedure TStream_WriteByte(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteByte(PByte(Params^[1])^);
end;

//procedure WriteWord(w : Word);
procedure TStream_WriteWord(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteWord(PWord(Params^[1])^);
end;

//procedure WriteDWord(d : Cardinal);
procedure TStream_WriteDWord(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteDWord(PCardinal(Params^[1])^);
end;

//Procedure WriteAnsiString (const S : String);
procedure TStream_WriteAnsiString(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.WriteAnsiString(PlpString(Params^[1])^);
end;

//Read: property Position: Int64 read Position write Position;
procedure TStream_Position_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt64(Result)^ := PStream(Params^[0])^.Position;
end;

//Write: property Position: Int64 read Position write Position;
procedure TStream_Position_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.Position := PInt64(Params^[1])^;
end;

//Read: property Size: Int64 read Size write Size;
procedure TStream_Size_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt64(Result)^ := PStream(Params^[0])^.Size;
end;

//Write: property Size: Int64 read Size write Size;
procedure TStream_Size_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^.Size := PInt64(Params^[1])^;
end;

//constructor Create();
procedure TStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStream(Params^[0])^ := TStream.Create();
end;

//procedure Free();
procedure TStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TStream.ReadDWord(): UInt32; constref;', @TStream_ReadDWord);
    ...
    addGlobalFunc('procedure TStream.WriteDWord(d : UInt32); constref;', @TStream_WriteDWord);
    ...
    addGlobalFunc('procedure TStream.Init(); override;', @TStream_Init);
    //addGlobalFunc('procedure TStream.Free(); constref;', @TStream_Free);
  end;
end;
{THandleStream}
//constructor Create(AHandle: THandle);
procedure THandleStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandleStream(Params^[0])^ := THandleStream.Create(PHandle(Params^[1])^);
end;

//function Read(var Buffer: pointer; Count: Longint): Longint;
procedure THandleStream_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure THandleStream_Write(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PHandleStream(Params^[0])^.Write(Ppointer(Params^[1])^, PLongint(Params^[2])^);
end;

//function Seek(const Offset: Int64; Origin: TSeekOrigin): Int64;
procedure THandleStream_Seek(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt64(Result)^ := PHandleStream(Params^[0])^.Seek(PInt64(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//Read: property Handle: Handle read Handle;
procedure THandleStream_Handle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandle(Result)^ := PHandleStream(Params^[0])^.Handle;
end;

//procedure Free();
procedure THandleStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFileStream(Params^[0])^ := TFileStream.Create(PlpString(Params^[1])^, PWord(Params^[2])^);
end;

//constructor Create(const AFileName: string; Mode: Word; Rights: Cardinal);
procedure TFileStream_InitEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFileStream_FileName_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFileStream(Params^[0])^.FileName;
end;

//procedure Free();
procedure TFileStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
//function Read(var Buffer: pointer; Count: LongInt): LongInt;
procedure TCustomMemoryStream_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCustomMemoryStream_Seek(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt64(Result)^ := PCustomMemoryStream(Params^[0])^.Seek(PInteger(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//procedure SaveToStream(Stream: TStream);
procedure TCustomMemoryStream_SaveToStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomMemoryStream(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//procedure SaveToFile(const FileName: string);
procedure TCustomMemoryStream_SaveToFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomMemoryStream(Params^[0])^.SaveToFile(PlpString(Params^[1])^);
end;

//Read: property Memory: Pointer read Memory;
procedure TCustomMemoryStream_Memory_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPointer(Result)^ := PCustomMemoryStream(Params^[0])^.Memory;
end;

//constructor Create();
procedure TCustomMemoryStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCustomMemoryStream(Params^[0])^ := TCustomMemoryStream.Create();
end;

//procedure Free();
procedure TCustomMemoryStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TCustomMemoryStream.Init(); override;', @TCustomMemoryStream_Init);
...
{TMemoryStream}
//procedure Clear;
procedure TMemoryStream_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMemoryStream(Params^[0])^.Clear();
end;

//procedure LoadFromStream(Stream: TStream);
procedure TMemoryStream_LoadFromStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMemoryStream(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure LoadFromFile(const FileName: string);
procedure TMemoryStream_LoadFromFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMemoryStream(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure SetSize(NewSize: PtrInt);
procedure TMemoryStream_SetSize(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMemoryStream(Params^[0])^.SetSize(PPtrInt(Params^[1])^);
end;

//function Write(const Buffer: pointer; Count: LongInt): LongInt;
procedure TMemoryStream_Write(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongInt(Result)^ := PMemoryStream(Params^[0])^.Write(PLongInt(Params^[1])^, PLongInt(Params^[2])^);
end;

//constructor Create();
procedure TMemoryStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMemoryStream(Params^[0])^ := TMemoryStream.Create();
end;

//procedure Free();
procedure TMemoryStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
   ...
   // addGlobalFunc('function TMemoryStream.Write(constref Buffer; Count: LongInt): LongInt; constref;', @TMemoryStream_Write);
    addGlobalFunc('procedure TMemoryStream.Init(); override;', @TMemoryStream_Init);
...
procedure TStringStream_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringStream(Params^[0])^ := TStringStream.Create(PlpString(Params^[1])^);
end;

//function Read(var Buffer: longint; Count: Longint): Longint;
procedure TStringStream_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PStringStream(Params^[0])^.Read(Plongint(Params^[1])^, PLongint(Params^[2])^);
end;

//function ReadString(Count: Longint): string;
procedure TStringStream_ReadString(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStringStream(Params^[0])^.ReadString(PLongint(Params^[1])^);
end;

//function Seek(Offset: Longint; Origin: Word): Longint;
procedure TStringStream_Seek(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStringStream_Write(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLongint(Result)^ := PStringStream(Params^[0])^.Write(PLongInt(Params^[1])^, PLongint(Params^[2])^);
end;

//procedure WriteString(const AString: string);
procedure TStringStream_WriteString(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringStream(Params^[0])^.WriteString(PlpString(Params^[1])^);
end;

//Read: property DataString: string read FDataString;
procedure TStringStream_DataString_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStringStream(Params^[0])^.DataString;
end;

//procedure Free();
procedure TStringStream_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStrings_Add(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.Add(PlpString(Params^[1])^);
end;

//function AddObject(const S: string; AObject: TObject): Integer;
procedure TStrings_AddObject(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.AddObject(PlpString(Params^[1])^, PObject(Params^[2])^);
end;

//procedure Append(const S: string);
procedure TStrings_Append(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Append(PlpString(Params^[1])^);
end;

//procedure AddStrings(const TheStrings: TStrings);
procedure TStrings_AddStrings(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.AddStrings(PStrings(Params^[1])^);
end;

//procedure Assign(Source: TPersistent);
procedure TStrings_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//procedure BeginUpdate;
procedure TStrings_BeginUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.BeginUpdate();
end;

//procedure Clear;
procedure TStrings_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Clear();
end;

//procedure Delete(Index: Integer);
procedure TStrings_Delete(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Delete(PInteger(Params^[1])^);
end;

//procedure EndUpdate;
procedure TStrings_EndUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.EndUpdate();
end;

//function EqualsObj(Obj: TObject): Boolean;
procedure TStrings_EqualsObj(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStrings(Params^[0])^.Equals(PObject(Params^[1])^);
end;

//function EqualsStrings(TheStrings: TStrings): Boolean;
procedure TStrings_EqualsStrings(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStrings(Params^[0])^.Equals(PStrings(Params^[1])^);
end;

//procedure Exchange(Index1, Index2: Integer);
procedure TStrings_Exchange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Exchange(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//function IndexOf(const S: string): Integer;
procedure TStrings_IndexOf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.IndexOf(PlpString(Params^[1])^);
end;

//function IndexOfName(const Name: string): Integer;
procedure TStrings_IndexOfName(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.IndexOfName(PlpString(Params^[1])^);
end;

//function IndexOfObject(AObject: TObject): Integer;
procedure TStrings_IndexOfObject(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.IndexOfObject(PObject(Params^[1])^);
end;

//procedure Insert(Index: Integer; const S: string);
procedure TStrings_Insert(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Insert(PInteger(Params^[1])^, PlpString(Params^[2])^);
end;

//procedure InsertObject(Index: Integer; const S: string;
procedure TStrings_InsertObject(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.InsertObject(PInteger(Params^[1])^, PlpString(Params^[2])^,PObject(Params^[3])^);
end;

//procedure LoadFromFile(const FileName: string);
procedure TStrings_LoadFromFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure LoadFromStream(Stream: TStream);
procedure TStrings_LoadFromStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure Move(CurIndex, NewIndex: Integer);
procedure TStrings_Move(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Move(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure SaveToFile(const FileName: string);
procedure TStrings_SaveToFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.SaveToFile(PlpString(Params^[1])^);
end;

//procedure SaveToStream(Stream: TStream);
procedure TStrings_SaveToStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//Read: property Count: Integer read Count;
procedure TStrings_Count_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStrings(Params^[0])^.Count;
end;

//Read: property Objects: TObject read Objects write Objects;
procedure TStrings_Objects_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PObject(Result)^ := PStrings(Params^[0])^.Objects[PInteger(Params^[1])^];
end;

//Write: property Objects: TObject read Objects write Objects;
procedure TStrings_Objects_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Objects[PInteger(Params^[1])^] := PObject(Params^[2])^;
end;

//Read: property Strings: string read Strings write Strings;
procedure TStrings_Strings_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStrings(Params^[0])^.Strings[PInteger(Params^[1])^];
end;

//Write: property Strings: string read Strings write Strings;
procedure TStrings_Strings_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Strings[PInteger(Params^[1])^] := PlpString(Params^[2])^;
end;

//Read: property Values[string]: string
procedure TStrings_Values_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStrings(Params^[0])^.Values[PlpString(Params^[1])^];
end;

//Write: property Values[string]: string
procedure TStrings_Values_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Values[PlpString(Params^[1])^] := PlpString(Params^[2])^;
end;

//Read: property Text: string read Text write Text;
procedure TStrings_Text_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PStrings(Params^[0])^.Text;
end;

//Write: property Text: string read Text write Text;
procedure TStrings_Text_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^.Text := PlpString(Params^[1])^;
end;

//constructor Create();
procedure TStrings_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStrings(Params^[0])^ := TStrings.Create();
end;

//procedure Free();
procedure TStrings_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
   ...
   // addGlobalFunc('procedure TStrings.Assign(Source: TPersistent); constref;', @TStrings_Assign);
    ...
    addGlobalFunc('procedure TStrings.Init(); override;', @TStrings_Init);
...
//function Add(const S: string): Integer;
procedure TStringList_Add(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStringList(Params^[0])^.Add(PlpString(Params^[1])^);
end;

//procedure Clear;
procedure TStringList_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Clear();
end;

//procedure Delete(Index: Integer);
procedure TStringList_Delete(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Delete(PInteger(Params^[1])^);
end;

//procedure Exchange(Index1, Index2: Integer);
procedure TStringList_Exchange(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Exchange(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//function Find(const S: string; Out Index: Integer): Boolean;
procedure TStringList_Find(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStringList(Params^[0])^.Find(PlpString(Params^[1])^, PInteger(Params^[2])^);
end;

//function IndexOf(const S: string): Integer;
procedure TStringList_IndexOf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PStringList(Params^[0])^.IndexOf(PlpString(Params^[1])^);
end;

//procedure Insert(Index: Integer; const S: string);
procedure TStringList_Insert(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Insert(PInteger(Params^[1])^, PlpString(Params^[2])^);
end;

//procedure Sort;
procedure TStringList_Sort(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Sort();
end;

//procedure CustomSort(CompareFn: TStringListSortCompare);
procedure TStringList_CustomSort(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.CustomSort(PStringListSortCompare(Params^[1])^);
end;

//Read: property Sorted: Boolean read Sorted write Sorted;
procedure TStringList_Sorted_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PStringList(Params^[0])^.Sorted;
end;

//Write: property Sorted: Boolean read Sorted write Sorted;
procedure TStringList_Sorted_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.Sorted := PBoolean(Params^[1])^;
end;

//Read: property CaseSensitive: Boolean read CaseSensitive write CaseSensitive;
procedure TStringList_CaseSensitive_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStringList_CaseSensitive_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.CaseSensitive := PBoolean(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TStringList_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PStringList(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TStringList_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStringList_OnChanging_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStringList_OnChanging_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TStringList_OwnsObjects_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PStringList(Params^[0])^.OwnsObjects;
end;

//Write: property OwnsObjects : boolean read OwnsObjects write OwnsObjects;
procedure TStringList_OwnsObjects_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^.OwnsObjects := Pboolean(Params^[1])^;
end;

//constructor Create();
procedure TStringList_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PStringList(Params^[0])^ := TStringList.Create();
end;

//procedure Free();
procedure TStringList_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TStringList.Init(); override;', @TStringList_Init);
...
procedure TComponent_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^ := TComponent.Create(PComponent(Params^[1])^);
end;

//procedure DestroyComponents;
procedure TComponent_DestroyComponents(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.DestroyComponents();
end;

//procedure Destroying;
procedure TComponent_Destroying(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.Destroying();
end;

//function FindComponent(const AName: string): TComponent;
procedure TComponent_FindComponent(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Result)^ := PComponent(Params^[0])^.FindComponent(PlpString(Params^[1])^);
end;

//procedure InsertComponent(AComponent: TComponent);
procedure TComponent_InsertComponent(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.InsertComponent(PComponent(Params^[1])^);
end;

//procedure RemoveComponent(AComponent: TComponent);
procedure TComponent_RemoveComponent(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TComponent_Components(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TComponent_ComponentCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TComponent_ComponentIndex_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TComponent_ComponentIndex_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.ComponentIndex := PInteger(Params^[1])^;
end;

//Read: property ComponentState: TComponentState read FComponentState;
procedure TComponent_ComponentState_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponentState(Result)^ := PComponent(Params^[0])^.ComponentState;
end;

//Read: property Owner: TComponent read FOwner;
procedure TComponent_Owner_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TComponent_Name_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponentName(Result)^ := PComponent(Params^[0])^.Name;
end;

//Write: property Name: TComponentName read FName write SetName stored False;
procedure TComponent_Name_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.Name := PComponentName(Params^[1])^;
end;

//Read: property Tag: PtrInt read FTag write FTag default 0;
procedure TComponent_Tag_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPtrInt(Result)^ := PComponent(Params^[0])^.Tag;
end;

//Write: property Tag: PtrInt read FTag write FTag default 0;
procedure TComponent_Tag_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PComponent(Params^[0])^.Tag := PPtrInt(Params^[1])^;
end;

//procedure Free();
procedure TComponent_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
