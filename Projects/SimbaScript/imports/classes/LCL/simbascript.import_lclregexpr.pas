...
//constructor Create;
procedure TRegExpr_Init(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRegExpr(Params^[0])^ := TRegExpr.Create();
end;

//function Exec (const AInputString : RegExprString) : boolean; {$IFDEF OverMeth} overload;
procedure TRegExpr_Exec(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PRegExpr(Params^[0])^.Exec(PLPString(Params^[1])^);
end;

//function ExecNext : boolean;
procedure TRegExpr_ExecNext(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PRegExpr(Params^[0])^.ExecNext();
end;

//function ExecPos: boolean;
procedure TRegExpr_ExecPos(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TRegExpr_InputString_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TRegExpr_InputString_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRegExpr(Params^[0])^.InputString := PLPString(Params^[1])^;
end;

//function Substitute (const ATemplate : RegExprString) : RegExprString;
procedure TRegExpr_Substitute(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLPString(Result)^ := PRegExpr(Params^[0])^.Substitute(PLPString(Params^[1])^);
end;

//procedure Split (AInputStr : RegExprString; APieces : TStrings);
procedure TRegExpr_Split(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRegExpr(Params^[0])^.Split(PLPString(Params^[1])^, PStrings(Params^[2])^);
end;

//function Replace (AInputStr : RegExprString;
procedure TRegExpr_Replace(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLPString(Result)^ := PRegExpr(Params^[0])^.Replace(PLPString(Params^[1])^, PLPString(Params^[2])^, PBoolean(Params^[2])^);
end;

//Read: Expression
procedure TRegExpr_Expression_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLPString(Result)^ := PRegExpr(Params^[0])^.Expression;
end;

//Write: Expression
procedure TRegExpr_Expression_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PRegExpr(Params^[0])^.Expression := PLPString(Params^[1])^;
end;

//Read: property SubExprMatchCount : integer read GetSubExprMatchCount;
procedure TRegExpr_SubExprMatchCount_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PRegExpr(Params^[0])^.SubExprMatchCount;
end;

//Read: property MatchPos [Idx : integer] : PtrInt read GetMatchPos;
procedure TRegExpr_MatchPos_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPtrInt(Result)^ := PRegExpr(Params^[0])^.MatchPos[PInteger(Params^[1])^];
end;

//Read: property MatchLen [Idx : integer] : PtrInt read GetMatchLen;
procedure TRegExpr_MatchLen_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPtrInt(Result)^ := PRegExpr(Params^[0])^.MatchLen[PInteger(Params^[1])^];
end;

//Read: property Match [Idx : integer] : RegExprString read GetMatch;
procedure TRegExpr_Match_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PLPString(Result)^ := PRegExpr(Params^[0])^.Match[PInteger(Params^[1])^];
end;

//procedure Free();
procedure TRegExpr_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
