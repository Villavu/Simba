...
begin
  Script.Client.MFinder.WarnOnly := System.PBoolean(Params^[0])^;
end;
...
begin
  Script._WriteLn(DecompressString(Base64Decode(
...
procedure Lape_Import_Other(Compiler: TScriptCompiler);
begin
  with Compiler do
  begin
    Section := 'Other';
...
initialization
  RegisterScriptImport(@Lape_Import_Other);
