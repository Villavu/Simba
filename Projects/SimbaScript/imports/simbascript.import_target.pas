...
begin
  ScriptInstance.Client.IOManager.SetTargetEx(PSysProc(Params^[0])^);
end;

procedure Lape_SetDesktopAsClient(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  ScriptInstance.Client.IOManager.SetDesktop();
end;

procedure Lape_SetTargetArray(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInt32(Result)^ := ScriptInstance.Client.IOManager.SetTarget(PRGB32(PPtrUInt(Params^[0])^), Point(PInt32(Params^[1])^, PInt32(Params^[2])^));
end;
...
begin
  POSWindow(Result)^ := ScriptInstance.Client.IOManager.GetImageTarget().Handle;
end;

procedure Lape_GetTargetPID(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PUInt32(Result)^ := TOSWindow(ScriptInstance.Client.IOManager.GetImageTarget().Handle).GetPID();
end;
