...
function Algo_Box_Intersection(x,y: TBoxArray): TBoxArray;
function Algo_Point_Intersection(x,y: TPointArray): TPointArray;
function Algo_UInt8_Intersection(x,y: TByteArray): TByteArray;
