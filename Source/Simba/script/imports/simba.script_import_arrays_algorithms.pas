unit simba.script_import_arrays_algorithms;
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure MedianTPAEx(constref TPA: TPointArray; out x, y: Int32);', @Lape_MedianTPAEx);
    addGlobalFunc('function MedianTPA(constref TPA: TPointArray): TPoint;', @Lape_MedianTPA);
    ...
    addGlobalFunc('function ClearTPAFromTPA(const Points, PointsToClear: TPointArray): TPointArray', @Lape_ClearTPAFromTPA);
    ...
    addGlobalFunc('function TPAErode(constref TPA: TPointArray; Amount: Int32): TPointArray;', @Lape_TPAErode);
    addGlobalFunc('function TPAGrow(constref TPA: TPointArray; Amount: Int32): TPointArray;', @Lape_TPAGrow);
    addGlobalFunc('function PointsInRangeOf(constref Points, Other: TPointArray; MinDist, MaxDist: Double): TPointArray; overload;', @Lape_PointsInRangeOf);
    addGlobalFunc('function PointsInRangeOf(constref Points, Other: TPointArray; MinDistX, MinDistY, MaxDistX, MaxDistY: Double): TPointArray; overload;', @Lape_PointsInRangeOfEx);
  end;
end;
