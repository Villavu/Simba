unit simba.script_import_lclgraphics;
...
procedure TGraphicsObject_OnChanging_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TGraphicsObject_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PGraphicsObject(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TGraphicsObject_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphicsObject(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TGraphicsObject_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphicsObject(Params^[0])^ := TGraphicsObject.Create();
end;

//procedure Free();
procedure TGraphicsObject_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
{TFont}
//constructor Create;
procedure TFont_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^ := TFont.Create();
end;

//procedure Assign(Source: TPersistent);
procedure TFont_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//procedure BeginUpdate;
procedure TFont_BeginUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.BeginUpdate();
end;

//procedure EndUpdate;
procedure TFont_EndUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.EndUpdate();
end;

//function HandleAllocated: boolean;
procedure TFont_HandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PFont(Params^[0])^.HandleAllocated();
end;

//Read: property Handle: THandle read Handle write Handle;
procedure TFont_Handle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandle(Result)^ := PFont(Params^[0])^.Handle;
end;

//Write: property Handle: THandle read Handle write Handle;
procedure TFont_Handle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Handle := PHandle(Params^[1])^;
end;

//function IsDefault: boolean;
procedure TFont_IsDefault(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PFont(Params^[0])^.IsDefault();
end;

//function IsEqual(AFont: TFont): boolean;
procedure TFont_IsEqual(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PFont(Params^[0])^.IsEqual(PFont(Params^[1])^);
end;

//Read: property IsMonoSpace: boolean read GetIsMonoSpace;
procedure TFont_IsMonoSpace_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PFont(Params^[0])^.IsMonoSpace;
end;

//procedure SetDefault;
procedure TFont_SetDefault(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.SetDefault();
end;

//Read: property PixelsPerInch: Integer read PixelsPerInch write PixelsPerInch;
procedure TFont_PixelsPerInch_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PFont(Params^[0])^.PixelsPerInch;
end;

//Write: property PixelsPerInch: Integer read PixelsPerInch write PixelsPerInch;
procedure TFont_PixelsPerInch_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.PixelsPerInch := PInteger(Params^[1])^;
end;

//Read: property Color: TColor read Color write Color;
procedure TFont_Color_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColor(Result)^ := PFont(Params^[0])^.Color;
end;

//Write: property Color: TColor read Color write Color;
procedure TFont_Color_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Color := PColor(Params^[1])^;
end;

//Read: property Height: Integer read Height write Height;
procedure TFont_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PFont(Params^[0])^.Height;
end;

//Write: property Height: Integer read Height write Height;
procedure TFont_Height_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Height := PInteger(Params^[1])^;
end;

//Read: property Name: string read Name write Name;
procedure TFont_Name_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PlpString(Result)^ := PFont(Params^[0])^.Name;
end;

//Write: property Name: string read Name write Name;
procedure TFont_Name_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Name := PlpString(Params^[1])^;
end;

//Read: property Orientation: Integer read Orientation write Orientation;
procedure TFont_Orientation_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PFont(Params^[0])^.Orientation;
end;

//Write: property Orientation: Integer read Orientation write Orientation;
procedure TFont_Orientation_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Orientation := PInteger(Params^[1])^;
end;

//Read: property Pitch: Byte read Pitch write Pitch;
procedure TFont_Pitch_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFontPitch(Result)^ := PFont(Params^[0])^.Pitch;
end;

//Write: property Pitch: Byte read Pitch write Pitch;
procedure TFont_Pitch_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Pitch := PFontPitch(Params^[1])^;
end;

//Read: property Size: Integer read Size write Size;
procedure TFont_Size_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PFont(Params^[0])^.Size;
end;

//Write: property Size: Integer read Size write Size;
procedure TFont_Size_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Size := PInteger(Params^[1])^;
end;

//Read: property Style: TFontStyles read Style write Style;
procedure TFont_Style_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFontStyles(Result)^ := PFont(Params^[0])^.Style;
end;

//Write: property Style: TFontStyles read Style write Style;
procedure TFont_Style_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Style := PFontStyles(Params^[1])^;
end;

//Read Quality: TFontQuality read FQuality write SetQuality default fqDefault;
procedure TFont_Quality_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TFont_Quality_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Quality := PFontQuality(Params^[1])^;
end;

//procedure Free();
procedure TFont_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Params^[0])^.Free();
end;
...
{TPen}
//constructor Create;
procedure TPen_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^ := TPen.Create();
end;

//procedure Assign(Source: TPersistent);
procedure TPen_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//Read: property Handle: THandle read Handle write Handle;
procedure TPen_Handle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHandle(Result)^ := PPen(Params^[0])^.Handle;
end;

//Write: property Handle: THandle read Handle write Handle;
procedure TPen_Handle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Handle := PHandle(Params^[1])^;
end;

//Read: property Color: Integer read Color write Color ;
procedure TPen_Color_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PPen(Params^[0])^.Color;
end;

//Write: property Color: Integer read Color write Color ;
procedure TPen_Color_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Color := PInteger(Params^[1])^;
end;

//Read: property Cosmetic: Boolean read Cosmetic write Cosmetic;
procedure TPen_Cosmetic_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PPen(Params^[0])^.Cosmetic;
end;

//Write: property Cosmetic: Boolean read Cosmetic write Cosmetic;
procedure TPen_Cosmetic_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Cosmetic := PBoolean(Params^[1])^;
end;

//Read: property Mode: TPenMode read Mode Write Mode;
procedure TPen_Mode_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPenMode(Result)^ := PPen(Params^[0])^.Mode;
end;

//Write: property Mode: TPenMode read Mode Write Mode;
procedure TPen_Mode_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Mode := PPenMode(Params^[1])^;
end;

//Read: property Style: TPenStyle read Style Write Style;
procedure TPen_Style_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPenStyle(Result)^ := PPen(Params^[0])^.Style;
end;

//Write: property Style: TPenStyle read Style Write Style;
procedure TPen_Style_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Style := PPenStyle(Params^[1])^;
end;

//Read: property Width: integer read Width write Width;
procedure TPen_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PPen(Params^[0])^.Width;
end;

//Write: property Width: integer read Width write Width;
procedure TPen_Width_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Width := Pinteger(Params^[1])^;
end;

//procedure Free();
procedure TPen_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Params^[0])^.Free();
end;
...
{TBrush}
//procedure Assign(Source: TPersistent);
procedure TBrush_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//constructor Create;
procedure TBrush_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Params^[0])^ := TBrush.Create();
end;

//Read: property Color: Integer read Color write Color;
procedure TBrush_Color_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PBrush(Params^[0])^.Color;
end;

//Write: property Color: Integer read Color write Color;
procedure TBrush_Color_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Params^[0])^.Color := PInteger(Params^[1])^;
end;

//Read: property Style:TBrushStyle read Style write Style;
procedure TBrush_Style_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrushStyle(Result)^ := PBrush(Params^[0])^.Style;
end;

//Write: property Style:TBrushStyle read Style write Style;
procedure TBrush_Style_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Params^[0])^.Style := PBrushStyle(Params^[1])^;
end;

//procedure Free();
procedure TBrush_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
{TCanvas}
//procedure Lock;
procedure TCanvas_Lock(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Lock();
end;

//function TryLock: Boolean;
procedure TCanvas_TryLock(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PCanvas(Params^[0])^.TryLock();
end;

//procedure Unlock; ;
procedure TCanvas_Unlock(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Unlock();
end;

//procedure Refresh;
procedure TCanvas_Refresh(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Refresh();
end;

//procedure Changing;
procedure TCanvas_Changing(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Changing();
end;

//procedure Changed;
procedure TCanvas_Changed(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Changed();
end;

//procedure SaveHandleState;
procedure TCanvas_SaveHandleState(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.SaveHandleState();
end;

//procedure RestoreHandleState;
procedure TCanvas_RestoreHandleState(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.RestoreHandleState();
end;

//procedure Arc(ALeft, ATop, ARight, ABottom, SX, SY, EX, EY: Integer);
procedure TCanvas_Arc(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_Chord(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_CopyRect(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.CopyRect(PRect(Params^[1])^, PCanvas(Params^[2])^, PRect(Params^[3])^);
end;

//procedure DrawFocusRect(ARect: TRect);
procedure TCanvas_DrawFocusRect(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.DrawFocusRect(PRect(Params^[1])^);
end;

//procedure Ellipse(x1, y1, x2, y2: Integer);
procedure TCanvas_Ellipse(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Ellipse(PInteger(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

//procedure FillRect(X1,Y1,X2,Y2: Integer);
procedure TCanvas_FillRect(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_FloodFill(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_RadialPie(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_Pie(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_PolyBezier(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_PolyBezierEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_Polygon(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_PolygonEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Polygon(PPPoint(Params^[1])^, PInteger(Params^[2])^, Pboolean(Params^[3])^);
end;

//procedure Polygon( Points: TPointArray);
procedure TCanvas_PolygonExEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Polygon(PPointArray(Params^[1])^);
end;

//procedure Polyline( Points: TPointArray;StartIndex: Integer;NumPts: Integer);
procedure TCanvas_Polyline(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_PolylineEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Polyline(PPPoint(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure Polyline( Points: TPointArray);
procedure TCanvas_PolylineExEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Polyline(PPointArray(Params^[1])^);
end;

//procedure Rectangle(X1,Y1,X2,Y2: Integer);
procedure TCanvas_Rectangle(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_RectangleEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Rectangle(PRect(Params^[1])^);
end;

//procedure RoundRect(X1, Y1, X2, Y2: Integer; RX,RY: Integer);
procedure TCanvas_RoundRect(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_RoundRectEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.RoundRect(PRect(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^);
end;

//procedure TextOut(X,Y: Integer;  Text: String);
procedure TCanvas_TextOut(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TCanvas_TextRect(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.TextRect(PRect(Params^[1])^, Pinteger(Params^[2])^, Pinteger(Params^[3])^, PlpString(Params^[4])^);
end;

//function TextHeight( Text: string): Integer;
procedure TCanvas_TextHeight(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCanvas(Params^[0])^.TextHeight(PlpString(Params^[1])^);
end;

//function TextWidth( Text: string): Integer;
procedure TCanvas_TextWidth(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PCanvas(Params^[0])^.TextWidth(PlpString(Params^[1])^);
end;

//function HandleAllocated: boolean; virtual;
procedure TCanvas_HandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PCanvas(Params^[0])^.HandleAllocated();
end;

//Read: property AutoRedraw: Boolean read AutoRedraw write AutoRedraw;
procedure TCanvas_AutoRedraw_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PCanvas(Params^[0])^.AutoRedraw;
end;

//Write: property AutoRedraw: Boolean read AutoRedraw write AutoRedraw;
procedure TCanvas_AutoRedraw_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.AutoRedraw := PBoolean(Params^[1])^;
end;

//Read: property Brush: TBrush read Brush write Brush;
procedure TCanvas_Brush_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBrush(Result)^ := PCanvas(Params^[0])^.Brush;
end;

//Write: property Brush: TBrush read Brush write Brush;
procedure TCanvas_Brush_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Brush := PBrush(Params^[1])^;
end;

//Read: property CopyMode: TCopyMode read FCopyMode write FCopyMode;
procedure TCanvas_CopyMode_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCopyMode(Result)^ := PCanvas(Params^[0])^.CopyMode;
end;

//Write: property CopyMode: TCopyMode read FCopyMode write FCopyMode;
procedure TCanvas_CopyMode_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.CopyMode := PCopyMode(Params^[1])^;
end;

//Read: property Font: TFont read Font write Font;
procedure TCanvas_Font_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PFont(Result)^ := PCanvas(Params^[0])^.Font;
end;

//Write: property Font: TFont read Font write Font;
procedure TCanvas_Font_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Font := PFont(Params^[1])^;
end;

//Read: property Height: integer read Height;
procedure TCanvas_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCanvas(Params^[0])^.Height;
end;

//Read: property Pen: TPen read Pen write Pen;
procedure TCanvas_Pen_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPen(Result)^ := PCanvas(Params^[0])^.Pen;
end;

//Write: property Pen: TPen read Pen write Pen;
procedure TCanvas_Pen_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Pen := PPen(Params^[1])^;
end;

//Read: property Width: integer read Width;
procedure TCanvas_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pinteger(Result)^ := PCanvas(Params^[0])^.Width;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TCanvas_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCanvas(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TCanvas_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//Read: property OnChanging: TNotifyEvent read FOnChanging write FOnChanging;
procedure TCanvas_OnChanging_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PCanvas(Params^[0])^.OnChanging;
end;

//Write: property OnChanging: TNotifyEvent read FOnChanging write FOnChanging;
procedure TCanvas_OnChanging_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.OnChanging := PNotifyEvent(Params^[1])^;
end;

procedure TCanvas_GetPixels(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
var
  TPA: TPointArray;
  i, h: Integer;
begin
...
procedure TCanvas_Get_Pixel(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PColor(Result)^ := PCanvas(Params^[0])^.Pixels[PInteger(Params^[1])^, PInteger(Params^[2])^];
end;

procedure TCanvas_Set_Pixel(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Pixels[PInteger(Params^[1])^, PInteger(Params^[2])^] := PColor(Params^[3])^;
end;

procedure TCanvas_Set_Pixels(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
var
  TPA: TPointArray;
  i, h: integer;
  Col: TColor;
...
procedure TCanvas_SetPixels(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
var
  TPA: TPointArray;
  Cols: TIntegerArray;
  i, h: integer;
...
procedure TCanvas_Draw(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Draw(PInteger(Params^[1])^, PInteger(Params^[2])^, PGraphic(Params^[3])^);
end;

//constructor Create();
procedure TCanvas_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^ := TCanvas.Create();
end;

//procedure Free();
procedure TCanvas_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Free();
end;

procedure TCanvas_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Clear();
end;

procedure TCanvas_Frame(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Frame(PInteger(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

procedure TCanvas_Frame3D(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.Frame3D(PRect(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

procedure TCanvas_LineTo(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.LineTo(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

procedure TCanvas_MoveTo(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.MoveTo(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

procedure TCanvas_AntialiasingMode_Set(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Params^[0])^.AntialiasingMode := PAntialiasingMode(Params^[1])^;
end;

procedure TCanvas_AntialiasingMode_Get(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TGraphic_Assign(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//constructor Create;
procedure TGraphic_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^ := TGraphic.Create();
end;

//procedure Clear;
procedure TGraphic_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Clear();
end;

//procedure LoadFromFile(const Filename: string);
procedure TGraphic_LoadFromFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure SaveToFile(const Filename: string);
procedure TGraphic_SaveToFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.SaveToFile(PlpString(Params^[1])^);
end;

//Read: property Empty: Boolean read Empty;
procedure TGraphic_Empty_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Empty;
end;

//Read: property Height: Integer read Height write Height;
procedure TGraphic_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Height;
end;

//Write: property Height: Integer read Height write Height;
procedure TGraphic_Height_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Height := PInteger(Params^[1])^;
end;

//Read: property Modified: Boolean read Modified write Modified;
procedure TGraphic_Modified_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Modified;
end;

//Write: property Modified: Boolean read Modified write Modified;
procedure TGraphic_Modified_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Modified := PBoolean(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TGraphic_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PGraphic(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TGraphic_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//Read: property Palette: Integer read GetPalette write SetPalette;
procedure TGraphic_Palette_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Palette;
end;

//Write: property Palette: Integer read GetPalette write SetPalette;
procedure TGraphic_Palette_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TGraphic_PaletteModified_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TGraphic_PaletteModified_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.PaletteModified := PBoolean(Params^[1])^;
end;

//Read: property Transparent: Boolean read Transparent write Transparent;
procedure TGraphic_Transparent_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PGraphic(Params^[0])^.Transparent;
end;

//Write: property Transparent: Boolean read Transparent write Transparent;
procedure TGraphic_Transparent_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

//Read: property Width: Integer read Width write Width;
procedure TGraphic_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PGraphic(Params^[0])^.Width;
end;

//Write: property Width: Integer read Width write Width;
procedure TGraphic_Width_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Width := PInteger(Params^[1])^;
end;

//procedure Free();
procedure TGraphic_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Params^[0])^.Free();
end;

procedure TGraphic_LoadFromClipboardFormat(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
{TBitmap}
//constructor Create;
procedure TBitmap_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^ := TBitmap.Create();
end;

//procedure BeginUpdate(ACanvasOnly: Boolean);
procedure TBitmap_BeginUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.BeginUpdate(PBoolean(Params^[1])^);
end;

//procedure EndUpdate(AStreamIsValid: Boolean);
procedure TBitmap_EndUpdate(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.EndUpdate(PBoolean(Params^[1])^);
end;

//procedure FreeImage;
procedure TBitmap_FreeImage(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.FreeImage();
end;

//function BitmapHandleAllocated: boolean;
procedure TBitmap_BitmapHandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PBitmap(Params^[0])^.BitmapHandleAllocated();
end;

//function MaskHandleAllocated: boolean;
procedure TBitmap_MaskHandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PBitmap(Params^[0])^.MaskHandleAllocated();
end;

//function PaletteAllocated: boolean;
procedure TBitmap_PaletteAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PBitmap(Params^[0])^.PaletteAllocated();
end;

//procedure LoadFromStream(AStream: TStream);
procedure TBitmap_LoadFromStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure LoadFromStream(AStream: TStream; ASize: Cardinal);
procedure TBitmap_LoadFromStreamEx(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.LoadFromStream(PStream(Params^[1])^, PCardinal(Params^[2])^);
end;

//procedure SaveToStream(AStream: TStream); override;
procedure TBitmap_SaveToStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//procedure GetSize(var AWidth, AHeight: Integer);
procedure TBitmap_GetSize(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.GetSize(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure Mask(ATransparentColor: TColor);
procedure TBitmap_Mask(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.Mask(PColor(Params^[1])^);
end;

//function ReleaseBitmapHandle: HBITMAP;
procedure TBitmap_ReleaseBitmapHandle(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHBITMAP(Result)^ := PBitmap(Params^[0])^.ReleaseBitmapHandle();
end;

//function ReleaseMaskHandle: HBITMAP;
procedure TBitmap_ReleaseMaskHandle(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHBITMAP(Result)^ := PBitmap(Params^[0])^.ReleaseMaskHandle();
end;

//function ReleasePalette: HPALETTE;
procedure TBitmap_ReleasePalette(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHPALETTE(Result)^ := PBitmap(Params^[0])^.ReleasePalette();
end;

//Read: property Canvas: TCanvas read GetCanvas;
procedure TBitmap_Canvas_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PCanvas(Result)^ := PBitmap(Params^[0])^.Canvas;
end;

//function HandleAllocated: boolean;
procedure TBitmap_HandleAllocated(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PBitmap(Params^[0])^.HandleAllocated();
end;

//Read: property BitmapHandle: HBITMAP read BitmapHandle write BitmapHandle;
procedure TBitmap_BitmapHandle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHBITMAP(Result)^ := PBitmap(Params^[0])^.BitmapHandle;
end;

//Write: property BitmapHandle: HBITMAP read BitmapHandle write BitmapHandle;
procedure TBitmap_BitmapHandle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.BitmapHandle := PHBITMAP(Params^[1])^;
end;

//Read: property Masked: Boolean read Masked write Masked;
procedure TBitmap_Masked_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PBitmap(Params^[0])^.Masked;
end;

//Write: property Masked: Boolean read Masked write Masked;
procedure TBitmap_Masked_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.Masked := PBoolean(Params^[1])^;
end;

//Read: property MaskHandle: HBITMAP read MaskHandle write MaskHandle;
procedure TBitmap_MaskHandle_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PHBITMAP(Result)^ := PBitmap(Params^[0])^.MaskHandle;
end;

//Write: property MaskHandle: HBITMAP read MaskHandle write MaskHandle;
procedure TBitmap_MaskHandle_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TBitmap_TransparentColor_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TBitmap_TransparentColor_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TBitmap_TransparentMode_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TBitmap_TransparentMode_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.TransparentMode := PTransparentMode(Params^[1])^;
end;

//procedure Free();
procedure TBitmap_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.Free();
end;

procedure TBitmap_Transparent_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

procedure TBitmap_Transparent_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
{TPicture}
//constructor Create;
procedure TPicture_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^ := TPicture.Create();
end;

//procedure Clear;
procedure TPicture_Clear(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.Clear();
end;

//procedure LoadFromFile(const Filename: string);
procedure TPicture_LoadFromFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure LoadFromStream(Stream: TStream);
procedure TPicture_LoadFromStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure LoadFromStreamWithFileExt(Stream: TStream; const FileExt: string);
procedure TPicture_LoadFromStreamWithFileExt(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TPicture_SaveToFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.SaveToFile(PlpString(Params^[1])^, PlpString(Params^[2])^);
end;

//procedure SaveToStream(Stream: TStream);
procedure TPicture_SaveToStream(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//procedure SaveToStreamWithFileExt(Stream: TStream; const FileExt: string);
procedure TPicture_SaveToStreamWithFileExt(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TPicture_Bitmap_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBitmap(Result)^ := PPicture(Params^[0])^.Bitmap;
end;

//Write: property Bitmap: TBitmap read Bitmap write Bitmap;
procedure TPicture_Bitmap_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.Bitmap := PBitmap(Params^[1])^;
end;

//Read: property Graphic: TGraphic read FGraphic write SetGraphic;
procedure TPicture_Graphic_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PGraphic(Result)^ := PPicture(Params^[0])^.Graphic;
end;

//Write: property Graphic: TGraphic read FGraphic write SetGraphic;
procedure TPicture_Graphic_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.Graphic := PGraphic(Params^[1])^;
end;

//Read: property Height: Integer read Height;
procedure TPicture_Height_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PPicture(Params^[0])^.Height;
end;

//Read: property Width: Integer read Width;
procedure TPicture_Width_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PPicture(Params^[0])^.Width;
end;

//Read: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TPicture_OnChange_Read(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PNotifyEvent(Result)^ := PPicture(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read FOnChange write FOnChange;
procedure TPicture_OnChange_Write(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PPicture(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TPicture_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
begin
  ...
  begin
    ...
    //register graphics
    Lape_Import_TGraphicsObject(Compiler);
    Lape_Import_TFont(Compiler);
    Lape_Import_TPen(Compiler);
    Lape_Import_TBrush(Compiler);
    Lape_Import_TGraphic(Compiler);
    Lape_Import_TCanvas(Compiler);
    Lape_Import_TBitmap(Compiler);
    Lape_Import_TPicture(Compiler);
  end;
end;
