unit simba.script_import_tmdtms;
...
procedure TMDTMS_AddDTM(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMDTMS(Params^[0])^.AddDTM(PSDTM(Params^[1])^);
end;

//function AddDTM(const d: TMDTM): Integer;overload;
procedure TMDTMS_AddDTMEx(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMDTMS(Params^[0])^.AddDTM(PMDTM(Params^[1])^);
end;

//function ExistsDTM(index : integer) : boolean;
procedure TMDTMS_ExistsDTM(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  Pboolean(Result)^ := PMDTMS(Params^[0])^.ExistsDTM(Pinteger(Params^[1])^);
end;

//function GetDTM(index: Integer) :TMDTM;
procedure TMDTMS_GetDTM(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMDTM(Result)^ := PMDTMS(Params^[0])^.GetDTM(PInteger(Params^[1])^);
end;

//procedure FreeDTM(DTM: Integer);
procedure TMDTMS_FreeDTM(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMDTMS(Params^[0])^.FreeDTM(PInteger(Params^[1])^);
end;

//function StringToDTM(const S: String): Integer;
procedure TMDTMS_StringToDTM(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMDTMS(Params^[0])^.StringToDTM(PlpString(Params^[1])^);
end;

//constructor Create(Owner: TObject);
procedure TMDTMS_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMDTMS(Params^[0])^ := TMDTMS.Create(PObject(Params^[1])^);
end;

//procedure Free();
procedure TMDTMS_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
