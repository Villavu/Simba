...
function MatchTemplate_CCORR(var Cache: TMatchTemplateCache; Templ: TIntegerMatrix; Normed: Boolean): TSingleMatrix;
function MatchTemplateMask_CCORR(var Cache: TMatchTemplateCache; Template: TIntegerMatrix; Normed: Boolean): TSingleMatrix;
...
function __MatchTemplateMask_CCORR(var Cache: TMatchTemplateCache; const Template: TIntegerMatrix; Normed: Boolean): TSingleMatrix;
var
...
function MatchTemplateMask_CCORR(var Cache: TMatchTemplateCache; Template: TIntegerMatrix; Normed: Boolean): TSingleMatrix;
begin
  Result := __MatchTemplateMask_CCORR(Cache, Template, Normed);
end;
