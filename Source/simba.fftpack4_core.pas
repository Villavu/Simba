...
type
  ...
  TCfftf1Proc = procedure(const n: Int32; const c,ch,wa: RealArrayRef; const ifac: IntArrayRef; const isign: Int32);
...
begin
  ...
  iw1  := 2*n;
  iw2  := iw1+2*n;
  Cfftf1Dispatch(n,c,wsave,wsave+iw1, IntArrayRef(wsave+iw2), -1);
end; (* cfftf *)
