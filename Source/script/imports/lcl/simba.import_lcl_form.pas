...
begin
  ...
  begin
    ...
    addClassVar('TLazSizeConstraints', 'Control', 'TLazControl', @_LapeSizeConstraints_Control_Read);
    addClassVar('TLazSizeConstraints', 'OnChange', 'TLazNotifyEvent', @_LapeSizeConstraints_OnChange_Read, @_LapeSizeConstraints_OnChange_Write);
    addClassVar('TLazSizeConstraints', 'MaxHeight', 'Integer', @_LapeSizeConstraints_MaxHeight_Read, @_LapeSizeConstraints_MaxHeight_Write);
    addClassVar('TLazSizeConstraints', 'MaxWidth', 'Integer', @_LapeSizeConstraints_MaxWidth_Read, @_LapeSizeConstraints_MaxWidth_Write);
    addClassVar('TLazSizeConstraints', 'MinHeight', 'Integer', @_LapeSizeConstraints_MinHeight_Read, @_LapeSizeConstraints_MinHeight_Write);
    ...
    addClassVar('TLazCustomForm', 'AlphaBlend', 'Boolean', @_LapeCustomForm_AlphaBlend_Read, @_LapeCustomForm_AlphaBlend_Write);
    addClassVar('TLazCustomForm', 'AlphaBlendValue', 'Byte', @_LapeCustomForm_AlphaBlendValue_Read, @_LapeCustomForm_AlphaBlendValue_Write);
    addClassVar('TLazCustomForm', 'DefaultControl', 'TLazControl', @_LapeCustomForm_DefaultControl_Read, @_LapeCustomForm_DefaultControl_Write);
    addClassVar('TLazCustomForm', 'KeyPreview', 'Boolean', @_LapeCustomForm_KeyPreview_Read, @_LapeCustomForm_KeyPreview_Write);
    addClassVar('TLazCustomForm', 'PixelsPerInch', 'Integer', @_LapeCustomForm_PixelsPerInch_Read, @_LapeCustomForm_PixelsPerInch_Write);
    addClassVar('TLazCustomForm', 'RestoredLeft', 'Integer', @_LapeCustomForm_RestoredLeft_Read);
    addClassVar('TLazCustomForm', 'RestoredTop', 'Integer', @_LapeCustomForm_RestoredTop_Read);
    ...
    addClassVar('TLazForm', 'OnCloseQuery', 'TLazCloseQueryEvent', @_LapeForm_OnCloseQuery_Read, @_LapeForm_OnCloseQuery_Write);
    addClassVar('TLazForm', 'OnCreate', 'TLazNotifyEvent', @_LapeForm_OnCreate_Read, @_LapeForm_OnCreate_Write);
    addClassVar('TLazForm', 'OnDblClick', 'TLazNotifyEvent', @_LapeForm_OnDblClick_Read, @_LapeForm_OnDblClick_Write);
    addClassVar('TLazForm', 'OnDeactivate', 'TLazNotifyEvent', @_LapeForm_OnDeactivate_Read, @_LapeForm_OnDeactivate_Write);
    addClassVar('TLazForm', 'OnDestroy', 'TLazNotifyEvent', @_LapeForm_OnDestroy_Read, @_LapeForm_OnDestroy_Write);
    addClassVar('TLazForm', 'OnDropFiles', 'TLazDropFilesEvent', @_LapeForm_OnDropFiles_Read, @_LapeForm_OnDropFiles_Write);
    addClassVar('TLazForm', 'OnHide', 'TLazNotifyEvent', @_LapeForm_OnHide_Read, @_LapeForm_OnHide_Write);
    addClassVar('TLazForm', 'OnMouseDown', 'TLazMouseEvent', @_LapeForm_OnMouseDown_Read, @_LapeForm_OnMouseDown_Write);
    addClassVar('TLazForm', 'OnMouseEnter', 'TLazNotifyEvent', @_LapeForm_OnMouseEnter_Read, @_LapeForm_OnMouseEnter_Write);
    addClassVar('TLazForm', 'OnMouseLeave', 'TLazNotifyEvent', @_LapeForm_OnMouseLeave_Read, @_LapeForm_OnMouseLeave_Write);
    addClassVar('TLazForm', 'OnMouseMove', 'TLazMouseMoveEvent', @_LapeForm_OnMouseMove_Read, @_LapeForm_OnMouseMove_Write);
    addClassVar('TLazForm', 'OnMouseUp', 'TLazMouseEvent', @_LapeForm_OnMouseUp_Read, @_LapeForm_OnMouseUp_Write);
    addClassVar('TLazForm', 'OnMouseWheel', 'TLazMouseWheelEvent', @_LapeForm_OnMouseWheel_Read, @_LapeForm_OnMouseWheel_Write);
    addClassVar('TLazForm', 'OnMouseWheelDown', 'TLazMouseWheelUpDownEvent', @_LapeForm_OnMouseWheelDown_Read, @_LapeForm_OnMouseWheelDown_Write);
    addClassVar('TLazForm', 'OnMouseWheelUp', 'TLazMouseWheelUpDownEvent', @_LapeForm_OnMouseWheelUp_Read, @_LapeForm_OnMouseWheelUp_Write);
    addClassVar('TLazForm', 'OnShow', 'TLazNotifyEvent', @_LapeForm_OnShow_Read, @_LapeForm_OnShow_Write);
    ...
    addClassVar('TLazCommonDialog', 'OnClose', 'TLazNotifyEvent', @_LapeCommonDialog_OnClose_Read, @_LapeCommonDialog_OnClose_Write);
    addClassVar('TLazCommonDialog', 'OnCanClose', 'TLazCloseQueryEvent', @_LapeCommonDialog_OnCanClose_Read, @_LapeCommonDialog_OnCanClose_Write);
    addClassVar('TLazCommonDialog', 'OnShow', 'TLazNotifyEvent', @_LapeCommonDialog_OnShow_Read, @_LapeCommonDialog_OnShow_Write);
    addClassVar('TLazCommonDialog', 'Width', 'Integer', @_LapeCommonDialog_Width_Read, @_LapeCommonDialog_Width_Write);
    ...
    addClassVar('TLazFileDialog', 'Filter', 'String', @_LapeFileDialog_Filter_Read, @_LapeFileDialog_Filter_Write);
    addClassVar('TLazFileDialog', 'FilterIndex', 'Integer', @_LapeFileDialog_FilterIndex_Read, @_LapeFileDialog_FilterIndex_Write);
