...
begin
  ...
  begin
    ...
    addGlobalFunc(
      ...
      '  try',
      '    FileName := SimbaEnv.ScreenshotsPath + PathExtractNameWithoutExt(SCRIPT_FILE) + #32 + TDateTime.Now().ToString("dd-mm hh-mm-ss") + ".png";',
      ...
      '    begin',
      '      FileName := SimbaEnv.ScreenshotsPath + PathExtractNameWithoutExt(SCRIPT_FILE) + #32 + TDateTime.Now().ToString("dd-mm hh-mm-ss-zzz") + ".png";',
      '      if Save(FileName) then',
      '        Exit(FileName);',
      '',
      '      Sleep(50);',
