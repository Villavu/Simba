...
procedure _LapeMFinder_WarnOnly_Read(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
  Pboolean(Result)^ := PMFinder(Params^[0])^.WarnOnly;
end;

procedure _LapeMFinder_WarnOnly_Write(const Params: PParamArray); LAPE_WRAPPER_CALLING_CONV
begin
  PMFinder(Params^[0])^.WarnOnly := Pboolean(Params^[1])^;
end;

procedure _LapeMFinder_DefaultOperations(const Params: PParamArray); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindColorSpiral(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindColorSpiralTolerance(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindColorsSpiralTolerance(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindColoredArea(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindColoredAreaTolerance(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindBitmapIn(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindBitmapToleranceIn(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindBitmapSpiral(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindBitmapSpiralTolerance(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindBitmapsSpiralTolerance(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_FindDeformedBitmapToleranceIn(const Params: PParamArray; const Result: Pointer); LAPE_WRAPPER_CALLING_CONV
begin
...
procedure _LapeMFinder_Free(const Params: PParamArray); LAPE_WRAPPER_CALLING_CONV
begin
