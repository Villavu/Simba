...
type
  THasherCRC32 = class(TSimbaHasher)
  private
    FHash: Cardinal;
  public
...
procedure THasherCRC32.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC32.Final: String;
begin
  FHash := FHash xor $FFFFFFFF;
  Result := Hex(FHash, 8);
end;

constructor THasherCRC32.Create;
begin
  FHash := $FFFFFFFF;
end;
